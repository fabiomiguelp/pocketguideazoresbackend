                          ...
                          <div class="card-body">
                            <div class="table-box table-responsive">
                                ...
                                <tbody>
                                  <tr>
                                        ...
                                        <td class="d-flex align-items-center gap-3">
                                            <img src="{{ asset('assets/images/avatar/avatar-3.jpg') }}" alt="Avatar 1" class="avatar-md rounded-pill">
                                            <div>
                                  ...
                                  <tr>
                                        <td>2</td>
                                        <td class="d-flex align-items-center gap-3">
                                            <img src="{{ asset('assets/images/avatar/avatar-4.jpg') }}" alt="Avatar 2" class="avatar-md rounded-pill">
                                            <div>
                                  ...
                                  <tr>
                                      <td>3</td>
                                      <td class="d-flex align-items-center gap-3">
                                          <img src="{{ asset('assets/images/avatar/avatar-5.jpg') }}" alt="Avatar 3" class="avatar-md rounded-pill">
                                          <div>
                                  ...
                                  <tr>
                                      <td>4</td>
                                      <td class="d-flex align-items-center gap-3">
                                          <img src="{{ asset('assets/images/avatar/avatar-6.jpg') }}" alt="Avatar 4" class="avatar-md rounded-pill">
                                          <div>
                                  ...
                                  <tr>
                                      <td>5</td>
                                      <td class="d-flex align-items-center gap-3">
                                          <img src="{{ asset('assets/images/avatar/avatar-7.jpg') }}" alt="Avatar 5" class="avatar-md rounded-pill">
                                          <div>
                                  ...
                                  <tr>
                                      <td>6</td>
                                      <td class="d-flex align-items-center gap-3">
                                          <img src="{{ asset('assets/images/avatar/avatar-8.jpg') }}" alt="Avatar 6" class="avatar-md rounded-pill">
                                          <div>
                                  ...
                                  <tr>
                                    <td>7</td>
                                    <td class="d-flex align-items-center gap-3">
                                        <img src="{{ asset('assets/images/avatar/avatar-9.jpg') }}" alt="Avatar 7" class="avatar-md rounded-pill">
                                        <div>
                                            <h6 class="mb-1">Michael Scott</h6>
                                ...
                                <tr>
                                    <td>8</td>
                                    <td class="d-flex align-items-center gap-3">
                                        <img src="{{ asset('assets/images/avatar/avatar-10.jpg') }}" alt="Avatar 8" class="avatar-md rounded-pill">
                                        <div>
                                            <h6 class="mb-1">Dwight Schrute</h6>
                                ...
                                <tr>
                                    <td>9</td>
                                    <td class="d-flex align-items-center gap-3">
                                        <img src="{{ asset('assets/images/avatar/avatar-11.jpg') }}" alt="Avatar 9" class="avatar-md rounded-pill">
                                        <div>
                                            <h6 class="mb-1">Jim Halpert</h6>
                                ...
                                <tr>
                                    <td>10</td>
                                    <td class="d-flex align-items-center gap-3">
                                        <img src="{{ asset('assets/images/avatar/avatar-12.jpg') }}" alt="Avatar 10" class="avatar-md rounded-pill">
                                        <div>
                                            <h6 class="mb-1">Pam Beesly</h6>
