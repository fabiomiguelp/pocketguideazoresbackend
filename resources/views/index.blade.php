                            ...
                            <div class="row">
                                <div class="col-8">
                                    <div class="vector-image">
                                        <img class="img-fluid welcome-img w-200px mb-n20 mt-n5" src="{{ asset('assets/images/dashboard/upgrade-img.png') }}" alt="CRM Vector">
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="text-end">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="form-check">
                                                        ...
                                                        <img src="{{ asset('assets/images/avatar/avatar-1.jpg') }}" class="avatar-sm rounded-2 mx-2" alt="Avatar Image">
                                                        #0051134
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="form-check">
                                                        ...
                                                        <img src="{{ asset('assets/images/avatar/avatar-2.jpg') }}" class="avatar-sm rounded-2 mx-2" alt="Avatar Image">
                                                        #0021598
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="form-check">
                                                        ...
                                                        <img src="{{ asset('assets/images/avatar/avatar-3.jpg') }}" class="avatar-sm rounded-2 mx-2" alt="Avatar Image">
                                                        #0045976
                                                    </div>
                                                </td>
                                                <td>te@shroff.gmail.com</td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="form-check">
                                                        ...
                                                        <img src="{{ asset('assets/images/avatar/avatar-4.jpg') }}" class="avatar-sm rounded-2 mx-2" alt="Avatar Image">
                                                        #0074564
                                                    </div>
                                                </td>
                                                <td>te@shroff.gmail.com</td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="form-check">
                                                        ...
                                                        <img src="{{ asset('assets/images/avatar/avatar-5.jpg') }}" class="avatar-sm rounded-2 mx-2" alt="Avatar Image">
                                                        #0098546
                                                    </div>
                                                </td>
                                                <td>te@shroff.gmail.com</td>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center gap-4 mb-5">
                                    <img src="{{ asset('assets/images/flag/us.svg') }}" height="30" width="30" class="object-fit-cover rounded-circle">
                                    <div class="w-100">
                                    ...
                                    <img src="{{ asset('assets/images/flag/de.svg') }}" height="30" width="30" class="object-fit-cover rounded-circle">
                                    <div class="w-100">
                                        <div class="d-flex justify-content-between align-items-center fs-13">
                                ...
                                <div class="d-flex align-items-center gap-4 mb-5">
                                    <img src="{{ asset('assets/images/flag/ru.svg') }}" height="30" width="30" class="object-fit-cover rounded-circle">
                                    <div class="w-100">
                                        <div class="d-flex justify-content-between align-items-center fs-13">
                                    ...
                                    <img src="{{ asset('assets/images/flag/cn.svg') }}" height="30" width="30" class="object-fit-cover rounded-circle">
                                    <div class="w-100">
                                        <div class="d-flex justify-content-between align-items-center fs-13">
                            ...
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body product-body bg-body m-4 mt-0">
                                        <img src="{{ asset('assets/images/dashboard/shoeses.png') }}" class="img-fluid mx-auto d-block product-img1" alt="Product Image">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-center">
                                            <img src="{{ asset('assets/images/dashboard/enhanced_image.png') }}" class="img-fluid" alt="Enhanced Image">
                                        </div>
...
@section('js')
    ...
    <!-- File js -->
    <script src="{{ asset('assets/js/dashboard/e-commerce.init.js') }}"></script>
    <!-- App js -->
