                                    ...
                                    <table class="table table-hover text-nowrap">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="schedule-card">
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('assets/images/avatar/avatar-6.jpg') }}" class="rounded-circle avatar-md me-2" alt="Teacher">
                                                        <div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="schedule-card">
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('assets/images/avatar/avatar-2.jpg') }}" class="rounded-circle avatar-md me-2" alt="Teacher">
                                                        <div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="schedule-card">
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('assets/images/avatar/avatar-3.jpg') }}" class="rounded-circle avatar-md me-2" alt="Teacher">
                                                        <div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="schedule-card">
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('assets/images/avatar/avatar-4.jpg') }}" class="rounded-circle avatar-md me-2" alt="Teacher">
                                                        <div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="schedule-card">
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('assets/images/avatar/avatar-5.jpg') }}" class="rounded-circle avatar-md me-2" alt="Teacher">
                                                        <div>
...
@section('js')
    ...
    <!-- Init -->
    <script src="{{ asset('assets/js/app/teachers-schedule.init.js') }}"></script>
    <!-- App js -->
