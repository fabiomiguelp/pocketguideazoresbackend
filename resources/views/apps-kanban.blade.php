                                        ...
                                        <div id="b1">
                                            <div class="card border my-4">
                                                <div class="card-body p-4">
                                                    ...
                                                    <div class="py-3">
                                                        <h6 class="mb-1">My Trip Taylor</h6>
                                            ...
                                            <div class="card border my-4">
                                                ...
                                                <div class="card-footer p-4 d-flex align-items-center justify-content-between">
                                                    <div class="avatar-group">
                                                        ...
                                                        <a href="#!" class="avatar-item">
                                                            <img class="img-fluid avatar-sm" src="{{ asset('assets/images/avatar/avatar-11.jpg') }}" alt="avatar image">
                                                        </a>
                                                    </div>
                                                    <div class="d-flex justify-content-end gap-2 align-content-center fs-12">
                                            ...
                                            <div class="card border my-4">
                                                ...
                                                <div class="card-footer p-4 d-flex align-items-center justify-content-between">
                                                    <div class="avatar-group">
                                                        ...
                                                        <a href="#!" class="avatar-item">
                                                            <img class="img-fluid avatar-sm" src="{{ asset('assets/images/avatar/avatar-12.jpg') }}" alt="avatar image">
                                                        </a>
                                                    </div>
                                                    <div class="d-flex justify-content-end gap-2 align-content-center fs-12">
...
@section('js')
    ...
    <!-- File Js -->
    <script src="{{ asset('assets/js/app/kanban.init.js') }}"></script>
    <!-- App js -->
