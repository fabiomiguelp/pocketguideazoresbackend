<aside class="pe-app-sidebar" id="sidebar">
    <div class="pe-app-sidebar-logo px-6 d-flex align-items-center position-relative">
        <!--begin::Brand Image-->
        <a href="{{ route('admin.dashboard') }}" class="d-flex align-items-end logo-main">
            ...
            <h3 class="text-body-emphasis fw-bolder mb-0 ms-1">My Trip Taylor</h3>
        </a>
    ...
    <nav class="pe-app-sidebar-menu nav nav-pills" data-simplebar id="sidebar-simplebar">
        <div class="d-flex align-items-start flex-column w-100">
            <ul class="pe-main-menu list-unstyled">
                <!-- Admin -->
                <li class="pe-menu-title">Admin</li>
                <li class="pe-slide">
                    <a href="{{ route('admin.dashboard') }}" class="pe-nav-link {{ request()->routeIs('admin.dashboard') ? 'active' : '' }}">
                        <i class="ri-dashboard-line pe-nav-icon"></i>
                        <span class="pe-nav-content">Dashboard</span>
                    </a>
                </li>
                <li class="pe-slide">
                    <a href="{{ route('admin.users.index') }}" class="pe-nav-link {{ request()->routeIs('admin.users.*') ? 'active' : '' }}">
                        <i class="ri-group-line pe-nav-icon"></i>
                        <span class="pe-nav-content">User Management</span>
                    </a>
                </li>

                <!-- Trip Planner -->
                <li class="pe-menu-title">Trip Planner</li>
                <li class="pe-slide">
                    <a href="{{ route('admin.islands.index') }}" class="pe-nav-link {{ request()->routeIs('admin.islands.*') ? 'active' : '' }}">
                        <i class="ri-map-pin-line pe-nav-icon"></i>
                        <span class="pe-nav-content">Islands</span>
                    </a>
                </li>
                <li class="pe-slide">
                    <a href="{{ route('admin.cities.index') }}" class="pe-nav-link {{ request()->routeIs('admin.cities.*') ? 'active' : '' }}">
                        <i class="ri-building-line pe-nav-icon"></i>
                        <span class="pe-nav-content">Cities</span>
                    </a>
                </li>
                <li class="pe-slide">
                    <a href="{{ route('admin.trip-categories.index') }}" class="pe-nav-link {{ request()->routeIs('admin.trip-categories.*') ? 'active' : '' }}">
                        <i class="ri-compass-3-line pe-nav-icon"></i>
                        <span class="pe-nav-content">Trip Categories</span>
                    </a>
                </li>
                <li class="pe-slide">
                    <a href="{{ route('admin.budget-levels.index') }}" class="pe-nav-link {{ request()->routeIs('admin.budget-levels.*') ? 'active' : '' }}">
                        <i class="ri-money-euro-circle-line pe-nav-icon"></i>
                        <span class="pe-nav-content">Budget Levels</span>
                    </a>
                </li>
                <li class="pe-slide">
                    <a href="{{ route('admin.city-gems.index') }}" class="pe-nav-link {{ request()->routeIs('admin.city-gems.*') ? 'active' : '' }}">
                        <i class="ri-treasure-map-line pe-nav-icon"></i>
                        <span class="pe-nav-content">Hidden Gems</span>
                    </a>
                </li>
                <li class="pe-slide">
                    <a href="{{ route('admin.partners.index') }}" class="pe-nav-link {{ request()->routeIs('admin.partners.*') ? 'active' : '' }}">
                        <i class="ri-hand-heart-line pe-nav-icon"></i>
                        <span class="pe-nav-content">Partners</span>
                    </a>
                </li>
                <li class="pe-slide">
                    <a href="{{ route('admin.trips.index') }}" class="pe-nav-link {{ request()->routeIs('admin.trips.*') ? 'active' : '' }}">
                        <i class="ri-flight-takeoff-line pe-nav-icon"></i>
                        <span class="pe-nav-content">Trips</span>
                    </a>
                </li>
