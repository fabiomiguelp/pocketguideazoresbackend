...
@section('title', 'Advanced UI Sortable JS | Urbix Admin & Dashboards Template')
            ...
            <div class="row">
                ...
                <div class="col-xl-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="text-muted mb-4">The filter <code>'.sortablejs-custom-disabled'</code> in Sortable.js prevents specific elements from being dragged. This keeps certain items in place while allowing users to move others, improving control and user experience.</p>
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="text-muted mb-4">The group element in Sortable.js enables users to drag and drop items between sortable lists. Using the same group name allows easy movement of items, improving organization in applications like project management.</p>
                ...
                <div class="col-xl-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="text-muted mb-4">The option <code>swap: true</code> in Sortable.js enables users to swap two items during drag-and-drop. The <code>swapClass: "active"</code> highlights the items being swapped, improving user feedback and making rearranging intuitive.</p>
...
<script src="{{ asset('assets/js/ui/sortablejs.init.js') }}"></script>
