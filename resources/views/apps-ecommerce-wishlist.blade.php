                            ...
                            <div class="table-responsive">
                                <table class="table table-hover mb-0" id="cart-table">
                                    ...
                                    <tbody>
                                        <tr id="product-1">
                                            <td>
                                                <img src="{{ asset('assets/images/product/img-01.png') }}" alt="Cotton T-shirt" class="img-fluid avatar-xxl">
                                            </td>
                                            <td>
                                                <h6 class="mb-1">
                                        ...
                                        <tr id="product-2">
                                            <td>
                                                <img src="{{ asset('assets/images/product/img-02.png') }}" alt="Rollax Watch" class="img-fluid avatar-xxl">
                                            </td>
                                            <td>
                                                <h6 class="mb-1">
                                        ...
                                        <tr id="product-3">
                                            <td>
                                                <img src="{{ asset('assets/images/product/img-03.png') }}" alt="White Shoes" class="img-fluid avatar-xxl">
                                            </td>
                                            <td>
                                                <h6 class="mb-1">
...
<script src="{{ asset('assets/js/app/ecommerce-wishlist.init.js') }}"></script>
