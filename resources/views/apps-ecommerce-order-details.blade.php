                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <img src="{{ asset('assets/images/product/img-02.png') }}" class="avatar-xl me-3" alt="Smart Watch For Man">
                            ...
                            <hr>
                            <div class="d-flex align-items-center">
                                <img src="{{ asset('assets/images/product/img-04.png') }}" class="avatar-xl me-3" alt="Crop Top">
                                <div class="flex-grow-1">
                                    <h6>Crop Top</h6>
                                    <div class="d-flex text-muted fs-12">
                                        <span class="me-2"><i class="ri-palette-line"></i> Blue / Black</span>
                            ...
                            <hr>
                            <div class="d-flex align-items-center">
                                <img src="{{ asset('assets/images/product/img-03.png') }}" class="avatar-xl me-3" alt="Mens Sports Shoes">
                                <div class="flex-grow-1">
                            ...
                            <hr>
                            <div class="d-flex align-items-center">
                                <img src="{{ asset('assets/images/product/img-08.png') }}" class="avatar-xl me-3" alt="Girls Handbags Purse">
                                <div class="flex-grow-1">
...
<script src="{{ asset('assets/js/app/ecommerce-order-details.init.js') }}"></script>
