...
@section('title', 'UI Input Masks | Urbix Admin & Dashboards Template')
            ...
            <div class="row">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row g-5">
                                ...
                                <div class="col-12 col-xl-6 col-xxl-4">
                                    ...
                                    <input type="text" class="form-control" id="date-month" name="date-month" placeholder="DD/MM">
                                    <small class="text-muted">Example: 08/10</small>
                                </div>
                                <div class="col-12 col-xl-6 col-xxl-4">
                                    <label class="form-label" for="formatted-date">Formatted Date:</label>
                                    <input type="text" class="form-control" id="formatted-date" name="formatted-date" placeholder="YYYY-MM-DD">
                                    <small class="text-muted">Example: 2024-10-31</small>
                                </div>
                                <div class="col-12 col-xl-6 col-xxl-4">
                                    <label class="form-label" for="date-delimiters">Date Delimiters:</label>
                                    <input type="text" class="form-control" id="date-delimiters" name="date-delimiters" placeholder="DD/MM/YYYY">
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="text-muted">Use the fields below to enter a time. Make sure to follow the specified format:</p>
                            <div class="row g-5">
                                <div class="col-12 col-xl-6 col-xxl-4">
                                    <label class="form-label" for="simple-time">Select Time:</label>
                                    <input type="text" class="form-control" id="simple-time" name="simple-time" placeholder="HH:MM:SS AM/PM">
                                    <small class="text-muted">Example: 02:30:59 PM</small>
                                </div>
                                <div class="col-12 col-xl-6 col-xxl-4">
                                    <label class="form-label" for="minutes-seconds">Minutes & Seconds:</label>
                                    <input type="text" class="form-control" id="minutes-seconds" name="minutes-seconds" placeholder="MM:SS">
                                    <small class="text-muted">Example: 30:59</small>
                                </div>
                                <div class="col-12 col-xl-6 col-xxl-4">
                                    <label class="form-label" for="hours-minutes">Hours & Minutes:</label>
                                    <input type="text" class="form-control" id="hours-minutes" name="hours-minutes" placeholder="HH:MM">
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="text-muted">Fill out the following fields with your information. Please refer to the placeholders for guidance:</p>
                            <div class="row g-5">
                                <div class="col-12 col-xl-6 col-xxl-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="contact-number" name="contact-number" placeholder="123-456-7890">
                                    </div>
                                ...
                                <div class="col-12 col-xl-6 col-xxl-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="formatted-contact" name="formatted-contact" placeholder="(123) (456) (7890)">
                                    </div>
                                    <small class="text-muted">Example: (123) (456) (7890)</small>
                                </div>
                                <div class="col-12 col-xl-6 col-xxl-4">
                                    <label class="form-label" for="credit-card">Credit Card Number:</label>
                                    <input type="text" class="form-control" id="credit-card" name="credit-card" placeholder="XXXX XXXX XXXX XXXX">
                                    <small class="text-muted">Example: 1234 5678 9012 3456</small>
                                </div>
                                <div class="col-12 col-xl-6 col-xxl-4">
                                    <label class="form-label" for="numeral-format">Numeral Format:</label>
                                    <input type="text" class="form-control" id="numeral-format" name="numeral-format" placeholder="XX,XXX,XX">
                                ...
                                <div class="col-12 col-xl-6 col-xxl-4">
                                    ...
                                    <input type="text" class="form-control" id="formatted-price" name="formatted-price" placeholder="$1,234.56">
                                ...
                                <div class="col-12 col-xl-6 col-xxl-4">
                                    ...
                                    <input type="text" class="form-control" id="prefix-delimiters" name="prefix-delimiters" placeholder="Prefix - Value">
...
<script src="{{ asset('assets/js/ui/input-masks.init.js') }}"></script>
