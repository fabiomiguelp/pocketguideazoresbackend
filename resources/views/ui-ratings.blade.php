...
@section('title', 'Advanced UI Ratings | Urbix Admin & Dashboards Template')
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <div class="gl-star-rating gl-star-rating-prebuilt">
                                        ...
                                        <span class="gl-star-rating--stars">
                                            <span data-value="1"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="gl-emote">
                                            ...
                                            <span data-value="2"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="gl-emote">
                                            ...
                                            <span data-value="3"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="gl-emote">
                                            ...
                                            <span data-value="4"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="gl-emote">
                                                    <circle class="gl-emote-bg" fill="#FFD885" cx="12" cy="12" r="10"></circle>
                                            ...
                                            <span data-value="5"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="gl-emote">
                                                    <circle class="gl-emote-bg" fill="#FFD885" cx="12" cy="12" r="10"></circle>
                    ...
                    <div class="card card-h-100">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex flex-wrap align-items-center justify-content-between">
                                <p class="fs-14 mb-0 fw-medium">Show Some <span class="text-danger">❤</span> with rating :</p>
                                <div class="d-flex align-items-center gap-3">
                                    <input class="custom-rating" max="5" step="0.5" type="range" value="2.5">
                                </div>
                            </div>
                        </div>
                    </div>
...
<script src="{{ asset('assets/js/ui/rating.init.js') }}"></script>
