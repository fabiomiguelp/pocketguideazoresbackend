                    ...
                    <div class="card">
                        ...
                        <div class="card-body" data-simplebar style="height: 250px;">
                            <ul class="list-unstyled mb-0">
                                <li class="d-flex">
                                    <img src="{{ asset('assets/images/avatar/avatar-1.jpg') }}" class="avatar-md rounded-2 me-3" alt="Avatar images">
                                    <div>
                                ...
                                <hr>
                                <li class="d-flex">
                                    <img src="{{ asset('assets/images/avatar/avatar-2.jpg') }}" class="avatar-md rounded-2 me-3" alt="Avatar images">
                                    <div>
                                ...
                                <hr>
                                <li class="d-flex">
                                    <img src="{{ asset('assets/images/avatar/avatar-3.jpg') }}" class="avatar-md rounded-2 me-3" alt="Avatar images">
                                    <div>
                                ...
                                <hr>
                                <li class="d-flex">
                                    <img src="{{ asset('assets/images/avatar/avatar-4.jpg') }}" class="avatar-md rounded-2 me-3" alt="Avatar Images">
                                    <div>
                                ...
                                <hr>
                                <li class="d-flex">
                                    <img src="{{ asset('assets/images/avatar/avatar-5.jpg') }}" class="avatar-md rounded-2 me-3" alt="Avatar Images">
                                    <div>
...
<script type="module" src="{{ asset('assets/js/app/apps-calendar.init.js') }}"></script>
