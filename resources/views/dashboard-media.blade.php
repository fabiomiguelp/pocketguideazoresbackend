                                    ...
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('assets/images/secialmedia/facebook.png') }}" class="h-32px w-32px me-3" alt="Facebook">
                            ...
                            <div class="col-xl-4 col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('assets/images/secialmedia/instagram.png') }}" class="h-32px w-32px me-3" alt="Instagram">
                            ...
                            <div class="col-xl-4">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('assets/images/secialmedia/twitter.png') }}" class="h-32px w-32px me-3" alt="Twitter">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center gap-4 my-4">
                                    <div class="position-relative">
                                        ...
                                        <img src="{{ asset('assets/images/secialmedia/instagram.png') }}" class="position-absolute border-2 border border-white h-20px w-20px rounded-circle bg-success end-0 bottom-0" alt="Instagram">
                                    </div>
                                    <div class="w-100">
                                        <div>
                                ...
                                <div class="d-flex align-items-center gap-4 my-4">
                                    <div class="position-relative">
                                        ...
                                        <img src="{{ asset('assets/images/secialmedia/twitter.png') }}" class="position-absolute border-2 border border-white h-20px w-20px rounded-circle bg-success end-0 bottom-0" alt="Twitter">
                                    </div>
                                    <div class="w-100">
                                        <div>
                                            <h6 class="fs-16 mb-1">@samanthawilliam_</h6>
                                ...
                                <div class="d-flex align-items-center gap-4 my-4">
                                    <div class="position-relative">
                                        ...
                                        <img src="{{ asset('assets/images/secialmedia/behance.png') }}" class="position-absolute border-2 border border-white h-20px w-20px rounded-circle bg-success end-0 bottom-0" alt="Behance">
                                    </div>
                                    <div class="w-100">
                                        <div>
                                            <h6 class="fs-16 mb-1">@samanthawilliam_</h6>
                                ...
                                <div class="d-flex align-items-center gap-4 my-4">
                                    <div class="position-relative">
                                        ...
                                        <img src="{{ asset('assets/images/secialmedia/youtube.png') }}" class="position-absolute border-2 border border-white h-20px w-20px rounded-circle bg-success end-0 bottom-0" alt="You Tube">
                                    </div>
                                    <div class="w-100">
                                        <div>
                                            <h6 class="fs-16 mb-1">@samanthawilliam_</h6>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex mt-4">
                                    ...
                                    <div class="mt-auto">
                                        <img src="{{ asset('assets/images/dashboard/laptop.png') }}" class="img-fluid" width="300px" alt="Laptop">
                                    </div>
                                </div>
                            </div>
                        </div>
...
@section('js')
    ...
    <script src="{{ asset('assets/js/dashboard/media.init.js') }}"></script>
