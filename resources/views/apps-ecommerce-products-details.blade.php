                            ...
                            <div dir="ltr" class="swiper product-main bg-light p-6 rounded mb-4">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img class="img-fluid w-100" alt="Product Image" src="{{ asset('assets/images/product/img-25.png') }}">
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-fluid w-100" alt="Product Image" src="{{ asset('assets/images/product/img-26.png') }}">
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-fluid w-100" alt="Product Image" src="{{ asset('assets/images/product/img-27.png') }}">
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-fluid w-100" alt="Product Image" src="{{ asset('assets/images/product/img-28.png') }}">
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-fluid w-100" alt="Product Image" src="{{ asset('assets/images/product/img-29.png') }}">
                                    </div>
                                </div>
                            ...
                            <div class="swiper product-small">
                                <div class="swiper-wrapper gap-4">
                                    <div class="swiper-slide bg-light rounded">
                                        <img src="{{ asset('assets/images/product/img-25.png') }}" alt="Product Image" class="img-fluid cursor-pointer" />
                                    </div>
                                    <div class="swiper-slide bg-light-subtle rounded">
                                        <img src="{{ asset('assets/images/product/img-26.png') }}" alt="Product Image" class="img-fluid cursor-pointer" />
                                    </div>
                                    <div class="swiper-slide bg-light-subtle rounded">
                                        <img src="{{ asset('assets/images/product/img-27.png') }}" alt="Product Image" class="img-fluid cursor-pointer" />
                                    </div>
                                    <div class="swiper-slide bg-light-subtle rounded">
                                        <img src="{{ asset('assets/images/product/img-28.png') }}" alt="Product Image" class="img-fluid cursor-pointer" />
                                    </div>
                                    <div class="swiper-slide bg-light-subtle rounded">
                                        <img src="{{ asset('assets/images/product/img-29.png') }}" alt="Product Image" class="img-fluid cursor-pointer" />
                                    </div>
                                </div>
                            </div>
                        </div><!--End col-->
                                            ...
                                            <div class="d-flex justify-content-between flex-column min-h-160px">
                                                <div class="d-flex flex-wrap align-items-center justify-content-between mb-3 mb-md-0">
                                                  <div class="d-flex align-items-center">
                                                    <img src="{{ asset('assets/images/avatar/avatar-3.jpg') }}" class="rounded-circle me-3 avatar-md" alt="Reviewer Avatar">
                                                    <div>
                                                ...
                                                <div class="row align-items-end">
                                                  <div class="col-md-6">
                                                    <div class="d-flex gap-2">
                                                      <a href="#!">
                                                        <img src="{{ asset('assets/images/product/img-06.png') }}" class="img-thumbnail border-0 rounded w-50px" alt="Review Image 1">
                                                      </a>
                                                      <a href="#!">
                                                        <img src="{{ asset('assets/images/product/img-07.png') }}" class="img-thumbnail border-0 rounded w-50px" alt="Review Image 2">
                                                      </a>
                                                    </div>
                                                  </div>
                                    ...
                                    <div class="swiper-slide card border shadow-none rounded w-100 mb-0">
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between flex-column min-h-160px">
                                                <div class="d-flex flex-wrap align-items-center justify-content-between mb-3 mb-md-0">
                                                  <div class="d-flex align-items-center">
                                                    <img src="{{ asset('assets/images/avatar/avatar-4.jpg') }}" class="rounded-circle me-3 avatar-md" alt="Reviewer Avatar">
                                                    <div>
                                                ...
                                                <div class="row align-items-end">
                                                  <div class="col-md-6">
                                                    <div class="d-flex gap-2">
                                                      <a href="#!">
                                                        <img src="{{ asset('assets/images/product/img-08.png') }}" class="img-thumbnail border-0 rounded w-50px" alt="Review Image 1">
                                                      </a>
                                                      <a href="#!">
                                                        <img src="{{ asset('assets/images/product/img-09.png') }}" class="img-thumbnail border-0 rounded w-50px" alt="Review Image 2">
                                                      </a>
                                                    </div>
                                                  </div>
                                                  <div class="col-md-6 text-sm-end mt-3 mt-sm-0">
                                    ...
                                    <div class="swiper-slide card border shadow-none rounded w-100 mb-0">
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between flex-column min-h-160px">
                                                <div class="d-flex flex-wrap align-items-center justify-content-between mb-3 mb-md-0">
                                                  <div class="d-flex align-items-center">
                                                    <img src="{{ asset('assets/images/avatar/avatar-5.jpg') }}" class="rounded-circle me-3 avatar-md" alt="Reviewer Avatar">
                                                    <div>
                                                ...
                                                <div class="row align-items-end">
                                                  <div class="col-md-6">
                                                    <div class="d-flex gap-2">
                                                      <a href="#!">
                                                        <img src="{{ asset('assets/images/product/img-10.png') }}" class="img-thumbnail border-0 rounded w-50px" alt="Review Image 1">
                                                      </a>
                                                      <a href="#!">
                                                        <img src="{{ asset('assets/images/product/img-11.png') }}" class="img-thumbnail border-0 rounded w-50px" alt="Review Image 2">
                                                      </a>
                                                    </div>
                                                  </div>
                                                  <div class="col-md-6 text-sm-end mt-3 mt-sm-0">
...
<script src="{{ asset('assets/js/app/ecommerce-product-detail.init.js') }}"></script>
