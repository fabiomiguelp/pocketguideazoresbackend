...
<!-- START -->
<div>
  <img src="{{ asset('assets/images/vector/planet.png') }}" alt="Startup Plan" class="startup-img object-fit-cover d-none d-xl-block">
  <img src="{{ asset('assets/images/vector/launch.png') }}" alt="Startup Plan" class="launch-img object-fit-cover animate-bounce d-none d-xl-block">
  ...
  <div class="px-3 px-md-8 py-5 position-absolute top-0 d-flex justify-content-between align-items-center w-100 z-1">
    <a href="index" class="d-flex align-items-end logo-main">
      <img height="35" class="logo-dark" alt="Dark Logo" src="{{ asset('assets/images/logo-md.png') }}">
...
@section('js')
<script src="{{ asset('assets/js/auth/coming-soon.init.js') }}"></script>
