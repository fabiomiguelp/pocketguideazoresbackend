                ...
                <table id="default_datatable" class="table table-nowrap">
                  ...
                  <tbody>
                    <tr>
                      <td>
                        <div class="d-flex align-items-center gap-3">
                          <img src="{{ asset('assets/images/product/img-01.png') }}" class="avatar-lg border rounded-1 p-1" alt="Product Image">
                          <div>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex align-items-center gap-3">
                          <img src="{{ asset('assets/images/product/img-02.png') }}" class="avatar-lg border rounded-1 p-1" alt="Product Image">
                          <div>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex align-items-center gap-3">
                          <img src="{{ asset('assets/images/product/img-03.png') }}" class="avatar-lg border rounded-1 p-1" alt="Product Image">
                          <div>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex align-items-center gap-3">
                          <img src="{{ asset('assets/images/product/img-04.png') }}" class="avatar-lg border rounded-1 p-1" alt="Product Image">
                          <div>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex align-items-center gap-3">
                          <img src="{{ asset('assets/images/product/img-05.png') }}" class="avatar-lg border rounded-1 p-1" alt="Product Image">
                          <div>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex align-items-center gap-3">
                          <img src="{{ asset('assets/images/product/img-06.png') }}" class="avatar-lg border rounded-1 p-1" alt="Product Image">
                          <div>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex align-items-center gap-3">
                          <img src="{{ asset('assets/images/product/img-07.png') }}" class="avatar-lg border rounded-1 p-1" alt="Product Image">
                          <div>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex align-items-center gap-3">
                          <img src="{{ asset('assets/images/product/img-08.png') }}" class="avatar-lg border rounded-1 p-1" alt="Product Image">
                          <div>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex align-items-center gap-3">
                          <img src="{{ asset('assets/images/product/img-09.png') }}" class="avatar-lg border rounded-1 p-1" alt="Product Image">
                          <div>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex align-items-center gap-3">
                          <img src="{{ asset('assets/images/product/img-10.png') }}" class="avatar-lg border rounded-1 p-1" alt="Product Image">
                          <div>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex align-items-center gap-3">
                          <img src="{{ asset('assets/images/product/img-11.png') }}" class="avatar-lg border rounded-1 p-1" alt="Shoes Image">
                          <div>
...
<script src="{{ asset('assets/js/app/ecommerce-product-list.init.js') }}"></script>
<!-- App js -->
