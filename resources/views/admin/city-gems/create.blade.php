...
@section('title', 'Create Hidden Gem | MyTripTaylor Admin')
@section('title-sub', 'Hidden Gems')
@section('pagetitle', 'Create Hidden Gem')
    ...
    <div class="col-lg-8 col-xl-6">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Create New Hidden Gem</h4>
            </div>
            <div class="card-body">
                @if ($errors->any())
                ...
                <form action="{{ route('admin.city-gems.store') }}" method="POST">
                    @csrf
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control @error('tip') is-invalid @enderror" id="tip" name="tip" value="{{ old('tip') }}">
                    </div>
                    <div class="d-flex gap-3">
                        <button type="submit" class="btn btn-primary">Create Gem</button>
...
<script>
    ...
    // Trigger on page load if old island_id exists
