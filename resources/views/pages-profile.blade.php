                    ...
                    <div class="d-flex justify-content-between flex-wrap align-items-center gap-6">
                        <div class="flex-shrink-0">
                            <div class="position-relative d-inline-block">
                                <img src="{{ asset('assets/images/avatar/avatar-3.jpg') }}" alt="Avatar Image" class="h-100px w-100px rounded-pill">
                                        ...
                                        <ul>
                                            <li class="box">
                                                ...
                                                <div class="mt-3 d-flex gap-2">
                                                    <img src="{{ asset('assets/images/small/img-13.jpg') }}" class="rounded h-56px" alt="Uploaded Image">
                                                    <img src="{{ asset('assets/images/small/img-12.jpg') }}" class="rounded h-56px" alt="Uploaded Image">
                                                </div>
                                            </li>
                                            <li class="box">
                                            ...
                                            <li class="box">
                                                ...
                                                <div class="mt-2">
                                                    <div class="avatar-group">
                                                        ...
                                                        <a href="#!" class="avatar-item">
                                                            <img class="img-fluid avatar-md" src="{{ asset('assets/images/avatar/avatar-4.jpg') }}" alt="avatar image">
                                                        </a>
                                                        <a href="#!" class="avatar-item">
                                                            <img class="img-fluid avatar-md" src="{{ asset('assets/images/avatar/avatar-5.jpg') }}" alt="avatar image">
                                                        </a>
                                                        <a href="#!" class="avatar-item">
                                                            <img class="img-fluid avatar-md" src="{{ asset('assets/images/avatar/avatar-6.jpg') }}" alt="avatar image">
                                                        </a>
                                            ...
                                            <li class="box">
                                                ...
                                                <div class="d-flex align-items-center gap-2 mt-2">
                                                    <img src="{{ asset('assets/images/avatar/avatar-10.jpg') }}" class="rounded-circle" alt="John Carter" width="32" height="32">
                                                    <div>
                                    ...
                                    <div class="mb-5 pb-5 border-bottom">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mt-4">
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="avatar-group">
                                                    <a href="#!" class="avatar-item">
                                                        <img class="img-fluid avatar-md" src="{{ asset('assets/images/avatar/avatar-2.jpg') }}" alt="avatar image">
                                                    </a>
                                                    <a href="#!" class="avatar-item">
                                                        <img class="img-fluid avatar-md" src="{{ asset('assets/images/avatar/avatar-3.jpg') }}" alt="avatar image">
                                                    </a>
                                                    <a href="#!" class="avatar-item">
                                                        <img class="img-fluid avatar-md" src="{{ asset('assets/images/avatar/avatar-7.jpg') }}" alt="avatar image">
                                                    </a>
                                                </div>
                                    ...
                                    <div class="mb-5 pb-5 border-bottom">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mt-4">
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="avatar-group">
                                                    <a href="#!" class="avatar-item">
                                                        <img class="img-fluid avatar-md" src="{{ asset('assets/images/avatar/avatar-8.jpg') }}" alt="avatar image">
                                                    </a>
                                                    <a href="#!" class="avatar-item">
                                                        <img class="img-fluid avatar-md" src="{{ asset('assets/images/avatar/avatar-1.jpg') }}" alt="avatar image">
                                                    </a>
                                                    <a href="#!" class="avatar-item">
                                                        <img class="img-fluid avatar-md" src="{{ asset('assets/images/avatar/avatar-6.jpg') }}" alt="avatar image">
                                                    </a>
                                    ...
                                    <div>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mt-4">
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="avatar-group">
                                                    <a href="#!" class="avatar-item">
                                                        <img class="img-fluid avatar-md" src="{{ asset('assets/images/avatar/avatar-9.jpg') }}" alt="avatar image">
                                                    </a>
                                                    <a href="#!" class="avatar-item">
                                                        <img class="img-fluid avatar-md" src="{{ asset('assets/images/avatar/avatar-2.jpg') }}" alt="avatar image">
                                                    </a>
                                    ...
                                    <div dir="ltr" class="swiper default-swiper">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <img src="{{ asset('assets/images/pages/post-1.jpg') }}" alt="Blog Post" class="img-fluid object-fit-cover h-100 w-100 rounded" />
                                            </div>
                                            <div class="swiper-slide">
                                                <img src="{{ asset('assets/images/pages/post-2.jpg') }}" alt="Blog Post" class="img-fluid object-fit-cover h-100 w-100 rounded" />
                                            </div>
                                            <div class="swiper-slide">
                                                <img src="{{ asset('assets/images/pages/post-3.jpg') }}" alt="Blog Post" class="img-fluid object-fit-cover h-100 w-100 rounded" />
                                            </div>
                                            <div class="swiper-slide">
                                                <img src="{{ asset('assets/images/pages/post-1.jpg') }}" alt="Blog Post" class="img-fluid object-fit-cover h-100 w-100 rounded" />
                                            </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('assets/images/avatar/avatar-1.jpg') }}" class="rounded-circle me-2 avatar-md" alt="User Avatar">
                                            <div>
                                    ...
                                    <img src="{{ asset('assets/images/small/img-2.jpg') }}" class="img-fluid w-100 object-fit-cover rounded" alt="Instagram Post">
                                                ...
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="avatar-group">
                                                            ...
                                                            <a href="#!" class="avatar-item">
                                                                <img class="img-fluid avatar-sm" src="{{ asset('assets/images/avatar/avatar-4.jpg') }}" alt="avatar image">
                                                            </a>
                                                            <a href="#!" class="avatar-item">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div>
                                                ...
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="avatar-group">
                                                            <a href="#!" class="avatar-item"><img class="img-fluid avatar-sm" src="{{ asset('assets/images/avatar/avatar-8.jpg') }}" alt="avatar"></a>
                                                            <a href="#!" class="avatar-item"><img class="img-fluid avatar-sm" src="{{ asset('assets/images/avatar/avatar-9.jpg') }}" alt="avatar"></a>
                                                        </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div>
                                                ...
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="avatar-group">
                                                            <a href="#!" class="avatar-item"><img class="img-fluid avatar-sm" src="{{ asset('assets/images/avatar/avatar-5.jpg') }}" alt="avatar"></a>
                                                            <a href="#!" class="avatar-item"><img class="img-fluid avatar-sm" src="{{ asset('assets/images/avatar/avatar-6.jpg') }}" alt="avatar"></a>
                                                        </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div>
                                                ...
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="avatar-group">
                                                            <a href="#!" class="avatar-item"><img class="img-fluid avatar-sm" src="{{ asset('assets/images/avatar/avatar-1.jpg') }}" alt="avatar"></a>
                                                            <a href="#!" class="avatar-item"><img class="img-fluid avatar-sm" src="{{ asset('assets/images/avatar/avatar-2.jpg') }}" alt="avatar"></a>
                                                        </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div>
                                                ...
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="avatar-group">
                                                            <a href="#!" class="avatar-item"><img class="img-fluid avatar-sm" src="{{ asset('assets/images/avatar/avatar-10.jpg') }}" alt="avatar"></a>
                                                        </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div>
                                                ...
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="avatar-group">
                                                            <a href="#!" class="avatar-item"><img class="img-fluid avatar-sm" src="{{ asset('assets/images/avatar/avatar-3.jpg') }}" alt="avatar"></a>
                                                        </div>
                                                        <span class="text-muted small d-none d-xxl-block">4 Members</span>
                                                    </div>
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <div class="card order-1 order-xl-2">
                            ...
                            <div class="card-body d-flex flex-column gap-6">
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <img src="{{ asset('assets/images/avatar/avatar-5.jpg') }}" class="rounded-circle avatar-md" alt="User">
                                    <div class="text-truncate">
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <img src="{{ asset('assets/images/avatar/avatar-7.jpg') }}" class="rounded-circle avatar-md" alt="User">
                                    <div class="text-truncate">
