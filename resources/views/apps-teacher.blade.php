                                    ...
                                    <table class="table table-hover text-nowrap">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('assets/images/avatar/avatar-1.jpg') }}" alt="Profile" class="avatar-md avatar-item me-1">
                                                        <div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('assets/images/avatar/avatar-2.jpg') }}" alt="Profile" class="avatar-md avatar-item me-1">
                                                        <div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('assets/images/avatar/avatar-3.jpg') }}" alt="Profile" class="avatar-md avatar-item me-1">
                                                        <div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('assets/images/avatar/avatar-4.jpg') }}" alt="Profile" class="avatar-md avatar-item me-1">
                                                        <div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('assets/images/avatar/avatar-5.jpg') }}" alt="Profile" class="avatar-md avatar-item me-1">
                                                        <div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('assets/images/avatar/avatar-6.jpg') }}" alt="Profile" class="avatar-md avatar-item me-1">
                                                        <div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('assets/images/avatar/avatar-8.jpg') }}" alt="Profile" class="avatar-md avatar-item me-1">
                                                        <div>
...
@section('js')
    ...
    <!-- Init -->
    <script src="{{ asset('assets/js/app/teachers.init.js') }}"></script>
    <!-- App js -->
