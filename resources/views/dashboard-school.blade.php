                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td class="fw-semibold">
                                                                    <img src="{{ asset('assets/images/avatar/avatar-1.jpg') }}" class="avatar-md rounded-circle" alt="Avatar Image">
                                                            ...
                                                            <tr>
                                                                <td class="fw-semibold">
                                                                    <img src="{{ asset('assets/images/avatar/avatar-2.jpg') }}" class="avatar-md rounded-circle" alt="Avatar Image">
                                                            ...
                                                            <tr>
                                                                <td class="fw-semibold">
                                                                    <img src="{{ asset('assets/images/avatar/avatar-3.jpg') }}" class="avatar-md rounded-circle" alt="Avatar Image">
                                                            ...
                                                            <tr>
                                                                <td class="fw-semibold">
                                                                    <img src="{{ asset('assets/images/avatar/avatar-4.jpg') }}" class="avatar-md rounded-circle" alt="Avatar Image">
                                                                    <span class="ms-3">Kathlyn hishn</span>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td class="fw-semibold">
                                                                    <img src="{{ asset('assets/images/avatar/avatar-5.jpg') }}" class="avatar-md rounded-circle" alt="Avatar Image">
                                                                    <span class="ms-3">Enos Schimel</span>
                                                                </td>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body card-h-100">
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('assets/images/dashboard/frem.png') }}" class="h-56px w-56px position-relative d-flex justify-content-center align-items-center rounded-3 me-3" alt="Frame">
                                            <div>
                                        ...
                                        <hr class="my-5">
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('assets/images/dashboard/frem1.png') }}" class="h-56px w-56px position-relative d-flex justify-content-center align-items-center rounded-3 me-3" alt="Frame">
                                            <div>
                                        ...
                                        <hr class="my-5">
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('assets/images/dashboard/frem2.png') }}" class="h-56px w-56px position-relative d-flex justify-content-center align-items-center rounded-3 me-3" alt="Frame">
                                            <div>
