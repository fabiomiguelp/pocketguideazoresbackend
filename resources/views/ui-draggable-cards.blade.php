...
@section('title', 'Advanced UI Draggable Cards | Urbix Admin & Dashboards Template')
@section('title-sub', 'Advanced UI')
@section('pagetitle', 'Draggable Cards')
...
<script src="{{ asset('assets/js/ui/card.init.js') }}"></script>
