...
@section('title', 'UI Range Slider | Urbix Admin & Dashboards Template')
                ...
                <div class="col-12 col-xl-6">
                    <div class="card card-h-100">
                        <div class="card-header d-flex align-items-center gap-3">
                            ...
                            <ul class="nav nav-pills nav-preview nav-primary mb-0" id="basic-range" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="html-basic-range-tab" data-bs-toggle="pill" data-bs-target="#html-basic-range" type="button" role="tab" aria-controls="html-basic-range" aria-selected="true">HTML</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="preview-basic-range-tab" data-bs-toggle="pill" data-bs-target="#preview-basic-range" type="button" role="tab" aria-controls="preview-basic-range" aria-selected="false">Preview</button>
                                </li>
                            </ul>
                        </div>
                        <div class="card-body">
                            <p class="text-muted">Create custom <code>&lt;input type="range"&gt;</code> controls with <code>.form-range</code>. The track (the background) and thumb (the value) are both styled to appear the same across browsers. As only Firefox supports “filling” their track from the left or right of the thumb as a means to visually indicate progress, we do not currently support it.</p>
                            <div class="tab-content" id="basic-range">
                                ...
                                <div class="tab-pane fade" id="preview-basic-range" role="tabpanel" aria-labelledby="preview-basic-range-tab" tabindex="0">
                ...
                <div class="col-12 col-xl-6">
                    <div class="card card-h-100">
                        <div class="card-header d-flex align-items-center gap-3">
                            ...
                            <ul class="nav nav-pills nav-preview nav-primary mb-0" id="disabled-range" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="html-disabled-range-tab" data-bs-toggle="pill" data-bs-target="#html-disabled-range" type="button" role="tab" aria-controls="html-disabled-range" aria-selected="true">HTML</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="preview-disabled-range-tab" data-bs-toggle="pill" data-bs-target="#preview-disabled-range" type="button" role="tab" aria-controls="preview-disabled-range" aria-selected="false">Preview</button>
                                </li>
                            </ul>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="tab-content" id="disabled-range">
                                <div class="tab-pane fade show active" id="html-disabled-range" role="tabpanel" aria-labelledby="html-disabled-range-tab" tabindex="0">
                                    <input type="range" class="form-range" disabled>
                                </div>
                                <div class="tab-pane fade" id="preview-disabled-range" role="tabpanel" aria-labelledby="preview-disabled-range-tab" tabindex="0">
                ...
                <div class="col-12 col-xl-6">
                    <div class="card card-h-100">
                        <div class="card-header d-flex align-items-center gap-3">
                            ...
                            <ul class="nav nav-pills nav-preview nav-primary mb-0" id="min-max-range" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="html-min-max-range-tab" data-bs-toggle="pill" data-bs-target="#html-min-max-range" type="button" role="tab" aria-controls="html-min-max-range" aria-selected="true">HTML</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="preview-min-max-range-tab" data-bs-toggle="pill" data-bs-target="#preview-min-max-range" type="button" role="tab" aria-controls="preview-min-max-range" aria-selected="false">Preview</button>
                                </li>
                            </ul>
                        </div>
                        <div class="card-body">
                            <p class="text-muted">Range inputs have implicit values for <code>min</code> and <code>max—0</code> and <code>100</code>, respectively. You may specify new values for those using the <code>min</code> and <code>max</code> attributes.</p>
                            <div class="tab-content" id="min-max-range">
                                <div class="tab-pane fade show active" id="html-min-max-range" role="tabpanel" aria-labelledby="html-min-max-range-tab" tabindex="0">
                                    <input type="range" class="form-range" min="0" max="5">
                                </div>
                                <div class="tab-pane fade" id="preview-min-max-range" role="tabpanel" aria-labelledby="preview-min-max-range-tab" tabindex="0">
                ...
                <div class="col-12 col-xl-6">
                    <div class="card card-h-100">
                        <div class="card-header d-flex align-items-center gap-3">
                            ...
                            <ul class="nav nav-pills nav-preview nav-primary mb-0" id="steps-range" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="html-steps-range-tab" data-bs-toggle="pill" data-bs-target="#html-steps-range" type="button" role="tab" aria-controls="html-steps-range" aria-selected="true">HTML</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="preview-steps-range-tab" data-bs-toggle="pill" data-bs-target="#preview-steps-range" type="button" role="tab" aria-controls="preview-steps-range" aria-selected="false">Preview</button>
                                </li>
                            </ul>
                        </div>
                        <div class="card-body">
                            <p class="text-muted">By default, range inputs “snap” to integer values. To change this, you can specify a <code>step</code> value. In the example below, we double the number of steps by using <code>step="0.5"</code>.</p>
                            <div class="tab-content" id="steps-range">
                                <div class="tab-pane fade show active" id="html-steps-range" role="tabpanel" aria-labelledby="html-steps-range-tab" tabindex="0">
                                    <input type="range" class="form-range" min="0" max="5" step="0.5">
                                </div>
                                <div class="tab-pane fade" id="preview-steps-range" role="tabpanel" aria-labelledby="preview-steps-range-tab" tabindex="0">
                ...
                <div class="col-12">
                    <div class="card card-h-100">
                        <div class="card-header d-flex align-items-center gap-3">
                            ...
                            <ul class="nav nav-pills nav-preview nav-primary mb-0" id="colors-range" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="html-colors-range-tab" data-bs-toggle="pill" data-bs-target="#html-colors-range" type="button" role="tab" aria-controls="html-colors-range" aria-selected="true">HTML</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="preview-colors-range-tab" data-bs-toggle="pill" data-bs-target="#preview-colors-range" type="button" role="tab" aria-controls="preview-colors-range" aria-selected="false">Preview</button>
                                </li>
                            </ul>
                        </div>
                        <div class="card-body">
                            <div class="tab-content" id="colors-range">
                                <div class="tab-pane fade show active" id="html-colors-range" role="tabpanel" aria-labelledby="html-colors-range-tab" tabindex="0">
                                    <div class="row g-4">
                                        <div class="col-12 col-xl-6">
                                ...
                                <div class="tab-pane fade" id="preview-colors-range" role="tabpanel" aria-labelledby="preview-colors-range-tab" tabindex="0">
            ...
            <div class="row">
                <div class="col-12 col-xl-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="text-muted">Use the fields below to enter a date. Please follow the specified format for each field:</p>
...
<script src="{{ asset('assets/js/ui/nouislider.init.js') }}"></script>
