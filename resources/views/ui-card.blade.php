...
@section('content')
            ...
            <div class="row">
                <div class="col-md-6 col-xl-3">
                    <div class="card">
                        <img src="{{ asset('assets/images/small/img-10.jpg') }}" class="card-img-top" alt="...">
                        <div class="card-body">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="d-flex gap-4 align-items-start mb-4">
                                <div class="avatar">
                                    <img src="{{ asset('assets/images/small/img-5.jpg') }}" alt="User Avatar" class="avatar-xl rounded object-fit-cover">
                                </div>
                                <div>
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <img src="{{ asset('assets/images/small/img-5.jpg') }}" alt="Card Image" class="w-100 h-144px object-fit-cover rounded mb-4">
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="card">
                        <img src="{{ asset('assets/images/small/img-1.jpg') }}" class="card-img-top" alt="Conference">
                        <div class="card-body">
                            <p class="card-text text-muted">
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="card">
                        ...
                        <img src="{{ asset('assets/images/small/img-2.jpg') }}" alt="Success image">
                        <div class="card-body">
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="card">
                        <img src="{{ asset('assets/images/small/img-3.jpg') }}" class="card-img-top" alt="Product Image">
                        <div class="card-body">
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="card">
                        <img src="{{ asset('assets/images/small/img-4.jpg') }}" class="card-img-top" alt="Product Image">
                        <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div id="carouselExample" class="carousel slide" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="{{ asset('assets/images/small/img-5.jpg') }}" class="d-block w-100" alt="Product Image 1">
                                </div>
                                <div class="carousel-item">
                                    <img src="{{ asset('assets/images/small/img-6.jpg') }}" class="d-block w-100" alt="Product Image 2">
                                </div>
                            </div>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="card card-h-100 blog-post-extended">
                        <img src="{{ asset('assets/images/small/img-14.jpg') }}" class="card-img-top" alt="Blog Image">
                        <div class="card-body">
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="card card-h-100 top-rated-card">
                        <div class="card-body">
                            <img src="{{ asset('assets/images/small/img-7.jpg') }}" class="card-img-top mb-3" alt="Product Image">
                    ...
                    <div class="card card-h-100 service-card-badge">
                        <div class="card-body d-flex flex-column justify-content-between">
                            <div class="mb-3 position-relative">
                                ...
                                <img src="{{ asset('assets/images/small/img-8.jpg') }}" class="card-img-top mb-3" alt="Service Image">
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="card text-bg-dark">
                        <img src="{{ asset('assets/images/small/img-4.jpg') }}" class="card-img" alt="...">
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="card card-h-100 text-bg-light">
                        <img src="{{ asset('assets/images/small/img-3.jpg') }}" class="card-img" alt="...">
                        <div class="card-img-overlay">
                            <h5 class="card-title text-reset">Card title</h5>
                            <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                            <p class="card-text"><small>Last updated 3 mins ago</small></p>
                    ...
                    <div class="row row-cols-1 row-cols-md-3 g-0">
                        <div class="col">
                            <div class="card border-0 rounded-end-0 shadow-sm">
                                <div class="card-body">
                                    <img src="{{ asset('assets/images/small/img-7.jpg') }}" alt="Logo" class="mx-auto w-100 rounded">
