                    ...
                    <div class="row">
                        <div class="col-md-6 col-xl-4 col-xxl-3">
                            <div class="card ecommerce-card">
                                ...
                                <div class="card-body text-start">
                                    <img src="{{ asset('assets/images/product/img-01.png') }}" class="img-fluid" alt="Crop Top">
                        ...
                        <div class="col-md-6 col-xl-4 col-xxl-3">
                            <div class="card ecommerce-card">
                                ...
                                <div class="card-body text-start">
                                    <img src="{{ asset('assets/images/product/img-02.png') }}" class="img-fluid" alt="Analog Wrist Watch">
                        ...
                        <div class="col-md-6 col-xl-4 col-xxl-3">
                            <div class="card ecommerce-card">
                                ...
                                <div class="card-body text-start">
                                    <img src="{{ asset('assets/images/product/img-03.png') }}" class="img-fluid" alt="Running Shoes">
                        ...
                        <div class="col-md-6 col-xl-4 col-xxl-3">
                            <div class="card ecommerce-card">
                                ...
                                <div class="card-body text-start">
                                    <img src="{{ asset('assets/images/product/img-04.png') }}" class="img-fluid" alt="Winter Crop Top">
                        ...
                        <div class="col-md-6 col-xl-4 col-xxl-3">
                            <div class="card ecommerce-card">
                                ...
                                <div class="card-body text-start">
                                    <img src="{{ asset('assets/images/product/img-05.png') }}" class="img-fluid" alt="Men's Casual T-Shirt">
                        ...
                        <div class="col-md-6 col-xl-4 col-xxl-3">
                            <div class="card ecommerce-card">
                                ...
                                <div class="card-body text-start">
                                    <img src="{{ asset('assets/images/product/img-06.png') }}" class="img-fluid" alt="Winter Crop Top">
                                    <a href="apps-ecommerce-products-details" class="fw-semibold text-body mb-1 text-truncate">Knitted Winter Crop Top</a>
                                    <p class="text-muted mb-3 text-truncate-2">Stay stylish and warm with this cozy knitted crop top—perfect for layering in colder seasons.</p>
                                    <div class="d-flex align-items-center justify-content-between flex-wrap mb-3">
                                        <div class="d-flex flex-grow-1">
                        ...
                        <div class="col-md-6 col-xl-4 col-xxl-3">
                            <div class="card ecommerce-card">
                                ...
                                <div class="card-body text-start">
                                    <img src="{{ asset('assets/images/product/img-07.png') }}" class="img-fluid" alt="Elegant Heels">
                        ...
                        <div class="col-md-6 col-xl-4 col-xxl-3">
                            <div class="card ecommerce-card">
                                ...
                                <div class="card-body text-start">
                                    <img src="{{ asset('assets/images/product/img-08.png') }}" class="img-fluid" alt="Elegant Purse">
...
<script type="module" src="{{ asset('assets/js/app/ecommerce-product.init.js') }}"></script>
<!-- App js -->
