...
@section('title', 'UI Form Layout | Urbix Admin & Dashboards Template')
                        ...
                        <div class="card-body">
                            ...
                            <form action="javascript:void(0);">
                                <div class="row g-4">
                                    ...
                                    <div class="col-xxl-6">
                                        <input type="text" class="form-control" id="basic-picker" placeholder="Date of Birth">
                                    </div>
                                    <div class="col-xxl-6">
                    ...
                    <div class="card card-h-100">
                        ...
                        <div class="card-body">
                            ...
                            <form action="javascript:void(0);">
                                <div class="row g-4">
                                    <div class="col-xxl-6">
                                        <input type="text" class="form-control" id="firstnameLayout2" placeholder="First Name" required>
                                    </div>
                                    <div class="col-xxl-6">
                                        <input type="text" class="form-control" id="lastnameLayout2" placeholder="Last Name" required>
                                    </div>
                                    <div class="col-xxl-6">
                                        <input type="email" class="form-control" id="emailLayout2" placeholder="Email" required>
                                    </div>
                                    <div class="col-xxl-6">
                                        <input type="tel" class="form-control" id="phoneLayout2" placeholder="Phone Number" required>
                                    </div>
                                    <div class="col-xxl-6">
                                        <input type="password" class="form-control" id="passwordLayout2" placeholder="Password" required>
                                    </div>
                                    <div class="col-xxl-6">
                                        <input type="text" class="form-control" id="basic-picker1" placeholder="Date of Birth" required>
                                    </div>
                                    <div class="col-12">
                                    ...
                                    <div class="col-12">
                                        <div class="form-check mb-4">
                                            ...
                                            <label class="form-check-label" for="termsLayout2">I agree to the terms and conditions</label>
                                        </div>
                                    </div>
                                </div>
                                <button type="submit" class="btn btn-primary">Submit Form</button>
                            ...
                            <form action="javascript:void(0);">
                                <div class="row g-4">
                                    <div class="col-xxl-6">
                                        ...
                                        <input type="text" class="form-control" id="firstNameLayout3" placeholder="First Name" required>
                                    </div>
                                    <div class="col-xxl-6">
                                        <label for="lastNameLayout3" class="form-label">Last Name</label>
                                        <input type="text" class="form-control" id="lastNameLayout3" placeholder="Last Name" required>
                                    </div>
                                    <div class="col-xxl-6">
                                        <label for="emailAddressLayout3" class="form-label">Email</label>
                                        <input type="email" class="form-control" id="emailAddressLayout3" placeholder="Email" required>
                                    </div>
                                    <div class="col-xxl-6">
                                        <label for="phoneNumberLayout3" class="form-label">Phone Number</label>
                                        <input type="tel" class="form-control" id="phoneNumberLayout3" placeholder="Phone Number" required>
                                    </div>
                                    <div class="col-xxl-6">
                                        <label for="basic-picker2" class="form-label">Date of Birth</label>
                                        <input type="text" class="form-control" id="basic-picker2" placeholder="Date of Birth" required>
                                    </div>
                                    <div class="col-xxl-6">
                                        <label for="companyNameLayout3" class="form-label">Company Name</label>
                                        <input type="text" class="form-control" id="companyNameLayout3" placeholder="Company Name" required>
                                    </div>
                                    <div class="col-12">
                                    ...
                                    <div class="col-xxl-6">
                                        ...
                                        <input type="text" class="form-control" id="zipCodeLayout3" placeholder="Zip Code" required>
                                    </div>
                                    <div class="col-xxl-6">
                                ...
                                <div class="row g-4">
                                    <div class="col-xxl-6">
                                        ...
                                        <div class="form-icon">
                                            ...
                                            <input type="text" class="form-control form-control-icon" id="firstNameLayout4" placeholder="First Name" required>
                                        </div>
                                    </div>
                                    <div class="col-xxl-6">
                                        ...
                                        <div class="form-icon">
                                            <i class="ri-user-line text-muted"></i>
                                            <input type="text" class="form-control form-control-icon" id="lastNameLayout4" placeholder="Last Name" required>
                                        </div>
                                    </div>
                                    <div class="col-xxl-6">
                                        ...
                                        <div class="form-icon">
                                            ...
                                            <input type="email" class="form-control form-control-icon" id="emailAddressLayout4" placeholder="Email" required>
                                        </div>
                                    </div>
                                    <div class="col-xxl-6">
                                        ...
                                        <div class="form-icon">
                                            ...
                                            <input type="tel" class="form-control form-control-icon" id="phoneNumberLayout4" placeholder="Phone Number" required>
                                        </div>
                                    </div>
                                    <div class="col-xxl-6">
                                        ...
                                        <div class="form-icon">
                                            ...
                                            <input type="text" class="form-control form-control-icon" id="basic-picker3" placeholder="Date of Birth" required>
                                        </div>
                                    </div>
                                    <div class="col-xxl-6">
                                        ...
                                        <div class="form-icon">
                                            ...
                                            <input type="text" class="form-control form-control-icon" id="companyNameLayout4" placeholder="Company Name" required>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        ...
                                        <div class="form-icon">
                                            ...
                                            <input class="form-control form-control-icon" id="addressInputLayout4" rows="2" placeholder="Address" required>
                                        </div>
                                    </div>
                                    <div class="col-xxl-6">
                                        ...
                                        <div class="form-icon">
                                            ...
                                            <input type="text" class="form-control form-control-icon" id="zipCodeLayout4" placeholder="Zip Code" required>
                                        </div>
                                    </div>
                                    <div class="col-xxl-6">
                                    ...
                                    <div class="col-12">
                                        <div class="form-check mb-4">
                                            ...
                                            <label class="form-check-label" for="termsLayout4">I agree to the terms and conditions</label>
                                        </div>
                                    </div>
                                </div>
                                <button type="submit" class="btn btn-primary">Submit Form</button>
                        ...
                        <div class="card-body">
                            ...
                            <form action="javascript:void(0);">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control" id="firstNameLayout5" placeholder="Full Name">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-lg-3 d-flex align-items-center">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="email" class="form-control" id="emailAddressLayout5" placeholder="Email">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-lg-3 d-flex align-items-center">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control" id="passwordLayout5" placeholder="Password">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-lg-3 d-flex align-items-center">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control" id="phoneNumberLayout5" placeholder="Phone Number">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-lg-3 d-flex align-items-center">
                                ...
                                <div class="col-lg-9 offset-lg-3">
                                    <div class="form-check mb-5">
                                        ...
                                        <label class="form-check-label" for="termsLayout5">I agree to the terms and conditions</label>
                                    </div>
                                </div>
                                <button type="submit" class="btn btn-primary">Submit Form</button>
                            </form>
                        ...
                        <div class="card-body">
                            ...
                            <form action="javascript:void(0);">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-lg-9 form-icon">
                                        <i class="ri-mail-line text-muted"></i>
                                        <input type="email" class="form-control form-control-icon" id="emailAddressLayout6" placeholder="Email">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-lg-3 d-flex align-items-center">
                                    ...
                                    <div class="col-lg-9 form-icon">
                                        ...
                                        <input type="text" class="form-control form-control-icon" id="passwordLayout6" placeholder="Password">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-lg-3 d-flex align-items-center">
                                    ...
                                    <div class="col-lg-9 form-icon">
                                        <i class="ri-phone-line text-muted"></i>
                                        <input type="text" class="form-control form-control-icon" id="phoneNumberLayout6" placeholder="Phone Number">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-lg-3 d-flex align-items-center">
                                ...
                                <div class="col-lg-9 offset-lg-3">
                                    <div class="form-check mb-5">
                                        ...
                                        <label class="form-check-label" for="termsLayout6">I agree to the terms and conditions</label>
                                    </div>
                                </div>
                                <button type="submit" class="btn btn-primary">Submit Form</button>
                            </form>
                        ...
                        <div class="card-body">
                            ...
                            <form action="javascript:void(0);">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" id="colFormLabelLg" placeholder="Email">
                                    </div>
                                </div>
                            </form>
                        </div>
