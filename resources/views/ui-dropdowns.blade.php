...
@section('title', 'Dropdowns | Urbix Admin & Dashboards Template')
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            ...
            <div class="card-body">
              <p class="text-muted">Create <strong>dropdowns</strong> with Bootstrap using the <code>&lt;div class="dropdown"&gt;</code> class and <code>&lt;button class="btn btn-secondary dropdown-toggle"&gt;</code> for the toggle. Include <code>&lt;ul class="dropdown-menu"&gt;</code> for the menu items.</p>
        ...
        <div class="col-lg-12">
          <div class="card">
            ...
            <div class="card-body">
              <p class="text-muted">Use <strong>dropdown color variants</strong> in Bootstrap by applying color classes like <code>.btn-primary</code> or <code>.btn-success</code> to the <code>&lt;button class="btn btn-primary"&gt;</code> for different styles.</p>
              <div class="d-flex flex-wrap gap-3">
                <div class="dropdown">
                  <button class="btn btn-primary dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                    Primary
        ...
        <div class="col-lg-12">
          <div class="card">
            ...
            <div class="card-body">
              <p class="text-muted">Create a <strong>split button dropdown</strong> with Bootstrap by using <code>.btn-group</code> and <code>.dropdown-toggle-split</code> classes. Apply these to separate the button and dropdown toggle.</p>
              <div class="d-flex flex-wrap gap-3">
                <div class="btn-group">
        ...
        <div class="col-lg-12">
          <div class="card">
            ...
            <div class="card-body">
              <p class="text-muted mb-4">Use <code>btn-lg</code> class to create a large size dropdown button and <code>btn-sm</code> to create a small size dropdown button.</p>
        ...
        <div class="col-lg-12">
          <div class="card">
            ...
            <div class="card-body">
              <p class="text-muted">Style <strong>dark dropdowns</strong> with Bootstrap by using the <code>.dropdown-menu-dark</code> class on the <code>&lt;ul&gt;</code> element for a dark theme.</p>
              <div class="d-flex flex-wrap gap-3">
                <div class="dropdown">
                  <button class="btn btn-secondary dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                    Dropdown button
        ...
        <div class="col-lg-12">
          <div class="card">
            ...
            <div class="card-body">
              <p class="text-muted">Enable <strong>hover dropdowns</strong> with Bootstrap by using the <code>.dropdown-hover</code> class. Apply this class to the <code>&lt;div class="dropdown"&gt;</code> container for dropdowns that appear on hover.</p>
              <div class="d-flex flex-wrap gap-3">
                <div class="dropdown">
                  <button class="btn btn-primary dropdown-toggle arrow-none" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                    Dropdown button
                  </button>
                  <ul class="dropdown-menu">
                    <li><a class="dropdown-item active" href="javascript:void(0)">Action</a></li>
        ...
        <div class="col-lg-12">
          <div class="card">
            ...
            <div class="card-body">
              <p class="text-muted">Align <strong>dropdown menus</strong> with Bootstrap using <code>.dropdown-menu-end</code> to right-align and <code>.dropdown-menu-start</code> to left-align the dropdown menu relative to the toggle button.</p>
              <div class="d-flex flex-wrap gap-3">
                <div class="btn-group">
                ...
                <div class="col-lg-6">
                  <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li class="dropend">
                        <a class="dropdown-item dropdown-toggle" role="button" id="dropdownMenuButton2" data-bs-toggle="dropdown" data-bs-offset="-9,2" aria-expanded="false" href="javascript:void(0)">New Group</a>
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton2">
                          <li><a class="dropdown-item" href="javascript:void(0)">Admin Group </a></li>
                          <li><a class="dropdown-item" href="javascript:void(0)">Staff Group </a></li>
                          <li><a class="dropdown-item" href="javascript:void(0)">Member Group </a></li>
                        </ul>
                      </li>
        ...
        <div class="col-lg-12">
          <div class="card">
            ...
            <div class="card-body">
              <p class="text-muted">Customize <strong>dropdown options</strong> in Bootstrap with <code>data-bs-offset</code> to adjust the dropdown position and <code>data-bs-reference</code> to specify the reference element for positioning.</p>
              <div class="d-flex flex-wrap gap-3">
                <div class="dropdown">
        ...
        <div class="col-lg-12">
          <div class="card">
            ...
            <div class="card-body">
              <p class="text-muted">Control <strong>auto-close behavior</strong> of dropdowns in Bootstrap using the <code>data-bs-auto-close</code> attribute. Set it to <code>"true"</code>, <code>"outside"</code>, or <code>"inside"</code> to define when the dropdown should close automatically.</p>
              <div class="d-flex flex-wrap gap-3">
                <div class="btn-group">
        ...
        <div class="col-lg-12">
          <div class="card">
            ...
            <div class="card-body">
              <p class="text-muted">Example of dropdown menu containing<code> Headers, Text and Forms </code>content.</p>
              <div class="d-flex flex-wrap gap-3">
                <!-- Header -->
                <div class="btn-group">
                  ...
                  <div class="dropdown-menu">
                    <div class="dropdown-header"> Welcome Urbix User! </div>
                    <!-- item-->
                    <a class="dropdown-item" href="javascript:void(0)">Action</a>
                    <a class="dropdown-item" href="javascript:void(0)">Another action</a>
                    <a class="dropdown-item" href="javascript:void(0)">Something else here</a>
                ...
                <div class="btn-group">
                  ...
                  <div class="dropdown-menu p-4 min-w-200px">
                    <form>
                      ...
                      <div class="mb-2">
                        <div class="form-check form-check-sm custom-checkbox d-flex align-items-center gap-2 mb-3">
