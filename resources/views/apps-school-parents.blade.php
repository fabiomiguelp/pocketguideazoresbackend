                                ...
                                <tbody>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-md avatar-item bg-primary text-white">
                                                    <img src="{{ asset('assets/images/avatar/avatar-2.jpg') }}" alt="Avatar Images">
                                                </div>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-md avatar-item bg-info text-white">
                                                    <img src="{{ asset('assets/images/avatar/avatar-5.jpg') }}" alt="Avatar Images">
                                                </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-md avatar-item bg-primary text-white">
                                                    <img src="{{ asset('assets/images/avatar/avatar-1.jpg') }}" alt="Avatar Images">
                                                </div>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-md avatar-item bg-info text-white">
                                                    <img src="{{ asset('assets/images/avatar/avatar-3.jpg') }}" alt="Avatar Images">
                                                </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-md avatar-item bg-primary text-white">
                                                    <img src="{{ asset('assets/images/avatar/avatar-6.jpg') }}" alt="Avatar Images">
                                                </div>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-md avatar-item bg-info text-white">
                                                    <img src="{{ asset('assets/images/avatar/avatar-7.jpg') }}" alt="Avatar Images">
                                                </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-md avatar-item bg-primary text-white">
                                                    <img src="{{ asset('assets/images/avatar/avatar-9.jpg') }}" alt="Avatar Images">
                                                </div>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-md avatar-item bg-info text-white">
                                                    <img src="{{ asset('assets/images/avatar/avatar-8.jpg') }}" alt="Avatar Images">
                                                </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-md avatar-item bg-primary text-white">
                                                    <img src="{{ asset('assets/images/avatar/avatar-10.jpg') }}" alt="Avatar Images">
                                                </div>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-md avatar-item bg-info text-white">
                                                    <img src="{{ asset('assets/images/avatar/avatar-11.jpg') }}" alt="Avatar Images">
                                                </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-md avatar-item bg-primary text-white">
                                                    <img src="{{ asset('assets/images/avatar/avatar-12.jpg') }}" alt="Avatar Images">
                                                </div>
...
@section('js')
    ...
    <!-- File js -->
    <script src="{{ asset('assets/js/app/school-parents.init.js') }}"></script>
    <!-- App js -->
