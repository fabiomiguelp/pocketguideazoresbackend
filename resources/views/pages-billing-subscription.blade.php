                      ...
                      <div class="img-checkbox billings-card mb-4">
                        ...
                        <label class="form-check-label mb-0 p-4" for="img-check-1">
                          <div class="d-flex align-items-start gap-4 mb-3">
                            <img src="{{ asset('assets/images/cards/visa.png') }}" alt="Visa" class="w-56px">
                  ...
                  <div class="card-wrapper overflow-hidden">
                      <div class="img-checkbox billings-card mb-4">
                        ...
                        <label class="form-check-label mb-0 p-4" for="img-check-2">
                          <div class="d-flex align-items-start gap-4 mb-3">
                            <img src="{{ asset('assets/images/cards/mastercard.png') }}" alt="MasterCard" class="w-56px">
                            <div class="flex-grow-1">
            ...
            <div class="col-xl-7 col-xxl-5">
              <div class="d-flex align-items-center flex-wrap p-5 border rounded">
                <div class="d-flex gap-5 py-4 w-auto mx-auto">
                  <img src="{{ asset('assets/images/avatar/avatar-5.jpg') }}" alt="Avatar Image" class="rounded-circle h-64px w-64px">
                  <div>
              ...
              <tbody>
                <tr>
                  ...
                  <td class="d-flex align-items-center gap-3">
                    <img src="{{ asset('assets/images/avatar/avatar-1.jpg') }}" alt="Avtar Image" class="avatar-md rounded-pill">
                    <div>
                ...
                <tr>
                  ...
                  <td class="d-flex align-items-center gap-3">
                    <img src="{{ asset('assets/images/avatar/avatar-2.jpg') }}" alt="Avtar Image" class="avatar-md rounded-pill">
                    <div>
                ...
                <tr>
                  ...
                  <td class="d-flex align-items-center gap-3">
                    <img src="{{ asset('assets/images/avatar/avatar-3.jpg') }}" alt="Avtar Image" class="avatar-md rounded-pill">
                    <div>
                ...
                <tr>
                  ...
                  <td class="d-flex align-items-center gap-3">
                    <img src="{{ asset('assets/images/avatar/avatar-4.jpg') }}" alt="Avtar Image" class="avatar-md rounded-pill">
                    <div>
                ...
                <tr>
                  ...
                  <td class="d-flex align-items-center gap-3">
                    <img src="{{ asset('assets/images/avatar/avatar-5.jpg') }}" alt="Avtar Image" class="avatar-md rounded-pill">
                    <div>
                ...
                <tr>
                  ...
                  <td class="d-flex align-items-center gap-3">
                    <img src="{{ asset('assets/images/avatar/avatar-6.jpg') }}" alt="Avtar Image" class="avatar-md rounded-pill">
                    <div>
