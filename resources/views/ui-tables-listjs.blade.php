...
@section('title', 'List JS Tables | Urbix Admin & Dashboards Template')
                                ...
                                <ul class="list-group list fs-13 fw-medium mt-3">
                                    <li class="list-group-item">
                                        <div class="d-flex align-items-center gap-2">
                                            <img class="avatar-md" src="{{ asset('assets/images/avatar/avatar-1.jpg') }}" alt="avatar image">
                                            <div>
                                    ...
                                    <li class="list-group-item">
                                        <div class="d-flex align-items-center gap-2">
                                            <img class="avatar-md" src="{{ asset('assets/images/avatar/avatar-2.jpg') }}" alt="avatar image">
                                            <div>
                                    ...
                                    <li class="list-group-item">
                                        <div class="d-flex align-items-center gap-2">
                                            <img class="avatar-md" src="{{ asset('assets/images/avatar/avatar-3.jpg') }}" alt="avatar image">
                                            <div>
                                    ...
                                    <li class="list-group-item">
                                        <div class="d-flex align-items-center gap-2">
                                            <img class="avatar-md" src="{{ asset('assets/images/avatar/avatar-4.jpg') }}" alt="avatar image">
                                            <div>
                                    ...
                                    <li class="list-group-item">
                                        <div class="d-flex align-items-center gap-2">
                                            <img class="avatar-md" src="{{ asset('assets/images/avatar/avatar-5.jpg') }}" alt="avatar image">
                                            <div>
                                                <p class="m-0 name fw-semibold" data-name="Sophia Andersson">Sophia Andersson</p>
                                                <p class="m-0 email text-muted" data-email="sophia@example.com">sophia@example.com</p>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="list-group-item">
                                        <div class="d-flex align-items-center gap-2">
                                            <img class="avatar-md" src="{{ asset('assets/images/avatar/avatar-6.jpg') }}" alt="avatar image">
                                            <div>
                                                <p class="m-0 name fw-semibold" data-name="Liam Johansson">Liam Johansson</p>
                                                <p class="m-0 email text-muted" data-email="liam@example.com">liam@example.com</p>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="list-group-item">
                                        <div class="d-flex align-items-center gap-2">
                                            <img class="avatar-md" src="{{ asset('assets/images/avatar/avatar-7.jpg') }}" alt="avatar image">
                                            <div>
                                                <p class="m-0 name fw-semibold" data-name="Emma Bergström">Emma Bergström</p>
                                                <p class="m-0 email text-muted" data-email="emma@example.com">emma@example.com</p>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="list-group-item">
                                        <div class="d-flex align-items-center gap-2">
                                            <img class="avatar-md" src="{{ asset('assets/images/avatar/avatar-8.jpg') }}" alt="avatar image">
                                            <div>
                                                <p class="m-0 name fw-semibold" data-name="Noah Eriksson">Noah Eriksson</p>
                                                <p class="m-0 email text-muted" data-email="noah@example.com">noah@example.com</p>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="list-group-item">
                                        <div class="d-flex align-items-center gap-2">
                                            <img class="avatar-md" src="{{ asset('assets/images/avatar/avatar-9.jpg') }}" alt="avatar image">
                                            <div>
                                                <p class="m-0 name fw-semibold" data-name="Olivia Karlsson">Olivia Karlsson</p>
                                                <p class="m-0 email text-muted" data-email="olivia@example.com">olivia@example.com</p>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
...
<script src="{{ asset('assets/js/ui/listjs.init.js') }}"></script>
