...
@section('title', 'School Course | Urbix Admin & Dashboards Template')
...
@section('content')
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="d-flex align-items-center gap-3">
                                            <img src="{{ asset('assets/images/avatar/avatar-1.jpg') }}" alt="Avtar 1" class="avatar-md rounded-pill">
                                            <div>
                                    ...
                                    <tr>
                                        <td>2</td>
                                        <td class="d-flex align-items-center gap-3">
                                            <img src="{{ asset('assets/images/avatar/avatar-2.jpg') }}" alt="Avtar 2" class="avatar-md rounded-pill">
                                            <div>
                                    ...
                                    <tr>
                                        <td>3</td>
                                        <td class="d-flex align-items-center gap-3">
                                            <img src="{{ asset('assets/images/avatar/avatar-3.jpg') }}" alt="Avtar 3" class="avatar-md rounded-pill">
                                            <div>
                                    ...
                                    <tr>
                                        <td>4</td>
                                        <td class="d-flex align-items-center gap-3">
                                            <img src="{{ asset('assets/images/avatar/avatar-4.jpg') }}" alt="Avtar 4" class="avatar-md rounded-pill">
                                            <div>
                                                <h6 class="mb-1">Web Development Bootcamp</h6>
                                                <p class="fs-12 mb-0 text-muted">Instructor: <span class="fw-semibold">Alice Johnson</span></p>
                                            </div>
                                        </td>
                                        <td><span class="badge bg-secondary-subtle text-secondary">Web
                                                Development</span></td>
                                    ...
                                    <tr>
                                        <td>5</td>
                                        <td class="d-flex align-items-center gap-3">
                                            <img src="{{ asset('assets/images/avatar/avatar-5.jpg') }}" alt="Avtar 5" class="avatar-md rounded-pill">
                                            <div>
                                                <h6 class="mb-1">Python for Data Analysis</h6>
                                                <p class="fs-12 mb-0 text-muted">Instructor: <span class="fw-semibold">Mark Lee</span></p>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td>6</td>
                                        <td class="d-flex align-items-center gap-3">
                                            <img src="{{ asset('assets/images/avatar/avatar-6.jpg') }}" alt="Avtar 6" class="avatar-md rounded-pill">
                                            <div>
                                                <h6 class="mb-1">Introduction to Cloud Computing</h6>
                                                <p class="fs-12 mb-0 text-muted">Instructor: <span class="fw-semibold">Sarah Williams</span></p>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td>7</td>
                                        <td class="d-flex align-items-center gap-3">
                                            <img src="{{ asset('assets/images/avatar/avatar-7.jpg') }}" alt="Avtar 7" class="avatar-md rounded-pill">
                                            <div>
                                                <h6 class="mb-1">React Native Development</h6>
                                                <p class="fs-12 mb-0 text-muted">Instructor: <span class="fw-semibold">Jessica Brown</span></p>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td>8</td>
                                        <td class="d-flex align-items-center gap-3">
                                            <img src="{{ asset('assets/images/avatar/avatar-8.jpg') }}" alt="Avtar 8" class="avatar-md rounded-pill">
                                            <div>
                                                <h6 class="mb-1">Cybersecurity Fundamentals</h6>
                                                <p class="fs-12 mb-0 text-muted">Instructor: <span class="fw-semibold">David Harris</span></p>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td>9</td>
                                        <td class="d-flex align-items-center gap-3">
                                            <img src="{{ asset('assets/images/avatar/avatar-9.jpg') }}" alt="Avtar 9" class="avatar-md rounded-pill">
                                            <div>
                                                <h6 class="mb-1">Blockchain Development</h6>
                                                <p class="fs-12 mb-0 text-muted">Instructor: <span class="fw-semibold">James Green</span></p>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td>10</td>
                                        <td class="d-flex align-items-center gap-3">
                                            <img src="{{ asset('assets/images/avatar/avatar-10.jpg') }}" alt="Avtar 10" class="avatar-md rounded-pill">
                                            <div>
                                                <h6 class="mb-1">Introduction to SQL</h6>
                                                <p class="fs-12 mb-0 text-muted">Instructor: <span class="fw-semibold">Olivia Wilson</span></p>
                                            </div>
                                        </td>
                ...
                <!-- Course Create Modal -->
                <div class="modal fade" id="createCourseModal" data-bs-keyboard="false" tabindex="-1" aria-labelledby="createCourseModalLabel" aria-hidden="true">
                                ...
                                <form>
                                    <div class="row g-3">
                                        <div class="col-12">
                                            <div class="d-flex flex-column align-items-center justify-content-center p-3 rounded">
                                                <div class="position-relative">
                                                    <img id="avatarPreview" src="{{ asset('assets/images/avatar/15.jpg') }}" alt="Avatar Preview" class="img-fluid rounded-circle h-80px w-80px object-fit-cover">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="text" class="form-control" id="courseCategory" placeholder="Enter category" required>
                                        </div>
                                        <div class="col-12">
                                            <label for="courseLessons" class="form-label">Lessons & Sections</label>
                                            <input type="text" class="form-control" id="courseLessons" placeholder="Enter lessons and sections" required>
                                        </div>
                                        <div class="col-12">
                                            <label for="courseEnrolled" class="form-label">Enrolled Students</label>
                                            <input type="number" class="form-control" id="courseEnrolled" placeholder="Enter enrolled" required>
                                        </div>
                                        <div class="col-12">
...
@section('js')
    ...
    <!-- File js -->
    <script src="{{ asset('assets/js/app/school-course.init.js') }}"></script>
    <!-- App js -->
