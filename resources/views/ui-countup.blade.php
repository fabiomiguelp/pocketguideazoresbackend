...
@section('title', 'Advanced UI Counter | Urbix Admin & Dashboards Template')
                                ...
                                <div class="col-12 col-md-6 col-xl-3">
                                    <div class="card card-body p-5 rounded-3 mb-0">
                                        <div class="d-flex justify-content-between align-items-start">
                                            ...
                                            <div class="h-48px w-48px bg-light-subtle rounded-circle d-flex align-items-center justify-content-center">
...
<script type="module" src="{{ asset('assets/js/ui/countup.init.js') }}"></script>
