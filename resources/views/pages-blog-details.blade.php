            ...
            <div class="card-body">
              <div class="d-flex flex-wrap justify-content-between align-items-center gap-5 mb-6">
                <div class="d-flex align-items-center gap-3">
                  <img src="{{ asset('assets/images/avatar/avatar-3.jpg') }}" alt="Liam Carter" class="rounded-circle shadow-sm avatar-md">
                  <div>
              ...
              <img src="{{ asset('assets/images/small/img-6.jpg') }}" class="img-fluid w-100 h-320px object-fit-cover rounded-3" alt="Blog Image">
              <div class="mt-5">
              ...
              <div class="px-5 mx-n5" data-simplebar style="height: 380px;">
                <div class="p-5 bg-light-subtle rounded-3 mb-4">
                  <div class="d-flex flex-wrap align-items-start gap-4">
                    <img src="{{ asset('assets/images/avatar/avatar-3.jpg') }}" alt="Don Russell" class="rounded-circle avatar-lg shadow-sm">
                ...
                <div class="p-5 bg-light-subtle rounded-3 mb-4 ms-5 ms-md-16">
                  <div class="d-flex flex-wrap align-items-start gap-4">
                    <img src="{{ asset('assets/images/avatar/avatar-2.jpg') }}" alt="Emily Carter" class="rounded-circle avatar-lg shadow-sm">
                    <div class="flex-grow-1">
                      <div class="d-flex justify-content-between mt-2 mb-3">
                ...
                <div class="p-5 bg-light-subtle rounded-3 mb-4">
                  <div class="d-flex flex-wrap align-items-start gap-4">
                    <img src="{{ asset('assets/images/avatar/avatar-5.jpg') }}" alt="Jacob Mendez" class="rounded-circle avatar-lg shadow-sm">
                    <div class="flex-grow-1">
                      <div class="d-flex justify-content-between mt-2 mb-3">
                ...
                <div class="p-5 bg-light-subtle rounded-3 mb-4">
                  <div class="d-flex flex-wrap align-items-start gap-4">
                    <img src="{{ asset('assets/images/avatar/avatar-6.jpg') }}" alt="Sophia Lin" class="rounded-circle avatar-lg shadow-sm">
                    <div class="flex-grow-1">
                      <div class="d-flex justify-content-between mt-2 mb-3">
                ...
                <div class="p-5 bg-light-subtle rounded-3 mb-4 ms-5 ms-md-20">
                  <div class="d-flex flex-wrap align-items-start gap-4">
                    <img src="{{ asset('assets/images/avatar/avatar-7.jpg') }}" alt="Liam Foster" class="rounded-circle avatar-lg shadow-sm">
                    <div class="flex-grow-1">
                      <div class="d-flex justify-content-between mt-2 mb-3">
                ...
                <div class="p-5 bg-light-subtle rounded-3 mb-4">
                  <div class="d-flex flex-wrap align-items-start gap-4">
                    <img src="{{ asset('assets/images/avatar/avatar-8.jpg') }}" alt="Nora Martinez" class="rounded-circle avatar-lg shadow-sm">
                    <div class="flex-grow-1">
                      <div class="d-flex justify-content-between mt-2 mb-3">
            ...
            <div class="card ">
              ...
              <div class="card-body">
                <div class="border-bottom pb-4">
                  <div class="d-flex gap-4 justify-content-between align-items-center">
                    <div class="flex-shrink-0">
                      <img src="{{ asset('assets/images/small/img-1.jpg') }}" class="rounded object-fit-cover h-64px w-100" alt="Blog Image">
                    </div>
                    <div class="flex-grow-1">
                ...
                <div class="border-bottom py-4">
                  <div class="d-flex gap-4 justify-content-between align-items-center">
                    <div class="flex-shrink-0">
                      <img src="{{ asset('assets/images/small/img-2.jpg') }}" class="rounded object-fit-cover h-64px w-100" alt="Blog Image">
                    </div>
                    <div class="flex-grow-1">
                ...
                <div class="border-bottom py-4">
                  <div class="d-flex gap-4 justify-content-between align-items-center">
                    <div class="flex-shrink-0">
                      <img src="{{ asset('assets/images/small/img-3.jpg') }}" class="rounded object-fit-cover h-64px w-100" alt="Blog Image">
                    </div>
                    <div class="flex-grow-1">
                ...
                <div class="py-4">
                  <div class="d-flex gap-4 justify-content-between align-items-center">
                    <div class="flex-shrink-0">
                      <img src="{{ asset('assets/images/small/img-4.jpg') }}" class="rounded object-fit-cover h-64px w-100" alt="Blog Image">
                    </div>
                    <div class="flex-grow-1">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="d-flex flex-wrap gap-3">
                  <img src="{{ asset('assets/images/small/img-7.jpg') }}" alt="Blog Post" class="img-fluid avatar-xxl object-fit-cover rounded-2">
                  <img src="{{ asset('assets/images/small/img-8.jpg') }}" alt="Blog Post" class="img-fluid avatar-xxl object-fit-cover rounded-2">
                  <img src="{{ asset('assets/images/small/img-9.jpg') }}" alt="Blog Post" class="img-fluid avatar-xxl object-fit-cover rounded-2">
                  <img src="{{ asset('assets/images/small/img-10.jpg') }}" alt="Blog Post" class="img-fluid avatar-xxl object-fit-cover rounded-2">
                  <img src="{{ asset('assets/images/small/img-11.jpg') }}" alt="Blog Post" class="img-fluid avatar-xxl object-fit-cover rounded-2">
                  <img src="{{ asset('assets/images/small/img-12.jpg') }}" alt="Blog Post" class="img-fluid avatar-xxl object-fit-cover rounded-2">
                  <img src="{{ asset('assets/images/small/img-13.jpg') }}" alt="Blog Post" class="img-fluid avatar-xxl object-fit-cover rounded-2">
                  <img src="{{ asset('assets/images/small/img-14.jpg') }}" alt="Blog Post" class="img-fluid avatar-xxl object-fit-cover rounded-2">
                </div>
              </div>
            </div>
            <div class="card">
