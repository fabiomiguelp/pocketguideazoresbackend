...
@section('title', 'Apex Line | Urbix Admin & Dashboards Template')
        ...
        <div class="col-12 col-xl-6">
          ...
          <div class="card card-h-100">
            <div class="card-body">
              ...
              <div id="Box_Whisker_chart" class="apexcharts-container"></div>
...
<script src="{{ asset('assets/js/chart/apexcharts-line.init.js') }}"></script>
