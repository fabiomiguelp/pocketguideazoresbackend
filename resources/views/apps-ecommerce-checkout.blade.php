                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="cart-item d-flex align-items-center">
                                <img src="{{ asset('assets/images/product/img-03.png') }}" alt="Men's White Shoes" class="avatar-xl">
                            ...
                            <hr>
                            <div class="cart-item d-flex align-items-center">
                                <img src="{{ asset('assets/images/product/img-01.png') }}" alt="Crop Top" class="avatar-xl">
                                <div class="ps-4 flex-grow-1">
                                    <h6>Crop Top</h6>
                                    <span>1x</span>
                                </div>
...
@section('js')
<script src="{{ asset('assets/js/app/ecommerce-checkout.init.js') }}"></script>
