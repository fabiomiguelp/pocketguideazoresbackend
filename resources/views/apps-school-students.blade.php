                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="d-flex align-items-center">
                                                    <img src="{{ asset('assets/images/avatar/avatar-1.jpg') }}" alt="Student" class="avatar-md rounded-circle me-2">
                                            ...
                                            <tr>
                                                <td>#STU-1002</td>
                                                <td class="d-flex align-items-center">
                                                    <img src="{{ asset('assets/images/avatar/avatar-3.jpg') }}" alt="Student" class="avatar-md rounded-circle me-2">
                                            ...
                                            <tr>
                                                <td>#STU-1003</td>
                                                <td class="d-flex align-items-center">
                                                    <img src="{{ asset('assets/images/avatar/avatar-12.jpg') }}" alt="Student" class="avatar-md rounded-circle me-2">
                                            ...
                                            <tr>
                                                <td>#STU-1004</td>
                                                <td class="d-flex align-items-center">
                                                    <img src="{{ asset('assets/images/avatar/avatar-5.jpg') }}" alt="Student" class="avatar-md rounded-circle me-2">
                                            ...
                                            <tr>
                                                <td>#STU-1005</td>
                                                <td class="d-flex align-items-center">
                                                    <img src="{{ asset('assets/images/avatar/avatar-4.jpg') }}" alt="Student" class="avatar-md rounded-circle me-2">
                                            ...
                                            <tr>
                                                <td>#STU-1006</td>
                                                <td class="d-flex align-items-center">
                                                    <img src="{{ asset('assets/images/avatar/avatar-6.jpg') }}" alt="Student" class="avatar-md rounded-circle me-2">
                                            ...
                                            <tr>
                                                <td>#STU-1007</td>
                                                <td class="d-flex align-items-center">
                                                    <img src="{{ asset('assets/images/avatar/avatar-7.jpg') }}" alt="Student" class="avatar-md rounded-circle me-2">
                                            ...
                                            <tr>
                                                <td>#STU-1008</td>
                                                <td class="d-flex align-items-center">
                                                    <img src="{{ asset('assets/images/avatar/avatar-8.jpg') }}" alt="Student" class="avatar-md rounded-circle me-2">
                                            ...
                                            <tr>
                                                <td>#STU-1009</td>
                                                <td class="d-flex align-items-center">
                                                    <img src="{{ asset('assets/images/avatar/avatar-9.jpg') }}" alt="Student" class="avatar-md rounded-circle me-2">
...
@section('js')
    ...
    <!-- Init -->
    <script src="{{ asset('assets/js/app/students.init.js') }}"></script>
    <!-- App js -->
