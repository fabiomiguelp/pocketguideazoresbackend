...
@section('title', 'UI File Upload | Urbix Admin & Dashboards Template')
            ...
            <div class="row">
                <div class="col-12 col-xl-6">
                    <div class="card card-h-100">
                        ...
                        <div class="card-body">
                            <p class="text-muted">Use the fields below to upload a file. Only images (JPG, PNG, GIF) up to 2MB are allowed.</p>
                            <div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center flex-wrap gap-3" data-uploader>
                                <div class="avatar-item avatar-xl">
                                    <img class="img-fluid avatar-xl" alt="avatar image" data-default-src="{{ asset('assets/images/avatar/avatar-2.jpg') }}" data-action="avatar-image">
                                </div>
