                        ...
                        <div class="card-body">
                            <div class="collapse show" id="itemsCollapse">
                                ...
                                <div class="d-sm-flex p-4 position-relative product-card">
                                    <img src="{{ asset('assets/images/product/img-01.png') }}" alt="Casual T-shirt" class="avatar-xxl me-3">
                                ...
                                <div class="d-sm-flex p-4 position-relative product-card">
                                    <img src="{{ asset('assets/images/product/img-02.png') }}" alt="Balck Watch" class="avatar-xxl me-3">
                                    <div class="flex-grow-1">
...
<script src="{{ asset('assets/js/app/ecommerce-cart.init.js') }}"></script>
