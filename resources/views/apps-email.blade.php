...
@section('css')
    ...
    <link rel="stylesheet" href="{{ asset('assets/libs/quill/quill.snow.css') }}">x.css">
@endsection
@section('content')
                    ...
                    <div class="message-list-content" data-simplebar>
                        <ul class="message-list" id="mail-list">
                            ...
                            <li class="inbox-data d-flex gap-3 gap-md-4 gap-xxl-6 align-items-center py-3 px-4 border-bottom cursor-pointer position-relative">
                                ...
                                <div class="avatar-item avatar-md">
                                    <img class="img-fluid avatar-md" src="{{ asset('assets/images/avatar/avatar-10.jpg') }}" alt="avatar image">
                                </div>
                            ...
                            <li class="inbox-data d-flex gap-3 gap-md-4 gap-xxl-6 align-items-center py-3 px-4 border-bottom cursor-pointer position-relative">
                                ...
                                <div class="avatar-item avatar-md">
                                    <img class="img-fluid avatar-md" src="{{ asset('assets/images/avatar/avatar-11.jpg') }}" alt="avatar image">
                                </div>
                            ...
                            <li class="inbox-data d-flex gap-3 gap-md-4 gap-xxl-6 align-items-center py-3 px-4 border-bottom cursor-pointer position-relative">
                                ...
                                <div class="avatar-item avatar-md">
                                    <img class="img-fluid avatar-md" src="{{ asset('assets/images/avatar/avatar-12.jpg') }}" alt="avatar image">
                                </div>
                    ...
                    <div class="mail-preview">
                        <div class="mail-header">
                            <div class="d-flex align-items-center">
                                ...
                                <img src="{{ asset('assets/images/avatar/avatar-1.jpg') }}" class="avatar-md me-2 rounded-circle" alt="Sender Avatar">
                                <div>
...
<script src="{{ asset('assets/js/app/apps-email.init.js') }}"></script>
