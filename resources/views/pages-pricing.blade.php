            ...
            <div class="row g-4">
                ...
                <div class="card mb-0 overflow-hidden">
                  <div class="card-body">
                    <div class="text-center">
                      <img src="{{ asset('assets/images/pages/starter.png') }}" alt="Starter" class="img-fluid w-80px">
              ...
              <div class="col-12 col-md-6 col-xl-3">
                <div class="card mb-0 ribbon right overflow-hidden">
                  ...
                  <div class="card-body">
                    <div class="text-center">
                      <img src="{{ asset('assets/images/pages/enterprise.png') }}" alt="Enterprise" class="img-fluid w-80px">
                      <div class="d-flex justify-content-center mt-2">
                        <sup class="h4 mt-3 mb-0 me-1">$</sup>
              ...
              <div class="col-12 col-md-6 col-xl-3">
                <div class="card mb-0 overflow-hidden">
                  <div class="card-body">
                    <div class="text-center">
                      <img src="{{ asset('assets/images/pages/growth.png') }}" alt="Growth" class="img-fluid w-80px">
                      <div class="d-flex justify-content-center mt-2">
                        <sup class="h4 mt-3 mb-0 me-1">$</sup>
              ...
              <div class="col-12 col-md-6 col-xl-3">
                <div class="card mb-0 overflow-hidden">
                  <div class="card-body">
                    <div class="text-center">
                      <img src="{{ asset('assets/images/pages/basic.png') }}" alt="Basic" class="img-fluid w-80px">
                      <div class="d-flex justify-content-center mt-2">
                        <sup class="h4 mt-3 mb-0 me-1">$</sup>
