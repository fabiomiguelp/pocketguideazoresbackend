                    ...
                    <div class="row gx-6 gy-3">
                        <div class="col-12">
                            <div class="main-blog-card position-relative rounded-3 overflow-hidden mb-4 shadow-sm">
                                <img src="{{ asset('assets/images/small/img-15.jpg') }}" alt="Article Image" class="img-fluid w-100 object-fit-cover h-500px">
                                <div class="p-6 bg-overlay">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                                        <div class="d-flex align-items-center gap-2">
                                            <img src="{{ asset('assets/images/avatar/avatar-2.jpg') }}" alt="Avatar" class="rounded-circle" width="32" height="32">
                                ...
                                <div class="card-body">
                                    <div dir="ltr" class="swiper default-swiper">
                                        <div class="swiper-wrapper">
                                            ...
                                            <div class="swiper-slide">
                                                <img src="{{ asset('assets/images/pages/post-5.jpg') }}" alt="Blog Post" class="img-fluid object-fit-cover h-100 w-100 rounded" />
                                            </div>
                                            <div class="swiper-slide">
                                                <img src="{{ asset('assets/images/pages/post-3.jpg') }}" alt="Blog Post" class="img-fluid object-fit-cover h-100 w-100 rounded" />
                                            </div>
                                            <div class="swiper-slide">
                                                <img src="{{ asset('assets/images/pages/post-6.jpg') }}" alt="Blog Post" class="img-fluid object-fit-cover h-100 w-100 rounded" />
                                            </div>
                                            <div class="swiper-slide">
                                                <img src="{{ asset('assets/images/pages/post-4.jpg') }}" alt="Blog Post" class="img-fluid object-fit-cover h-100 w-100 rounded" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-6 col-xxl-4">
                            <div class="card">
                                <div class="card-body">
                                    <img src="{{ asset('assets/images/small/img-1.jpg') }}" class="img-fluid rounded mb-5 w-100" alt="Blog image">
                        ...
                        <div class="col-md-6 col-xxl-4">
                            <div class="card">
                                <div class="card-body">
                                    <img src="{{ asset('assets/images/small/img-2.jpg') }}" class="img-fluid rounded mb-5 w-100" alt="Blog image">
                        ...
                        <div class="col-md-6 col-xxl-4">
                            <div class="card">
                                <div class="card-body">
                                    <img src="{{ asset('assets/images/small/img-3.jpg') }}" class="img-fluid rounded mb-5 w-100" alt="Blog image">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="border-bottom py-4">
                                    <div class="d-flex gap-4 justify-content-between align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="{{ asset('assets/images/small/img-6.jpg') }}" class="rounded object-fit-cover h-64px w-100" alt="Blog Image">
                                        </div>
                                ...
                                <div class="d-flex flex-wrap gap-4">
                                    <img src="{{ asset('assets/images/small/img-7.jpg') }}" alt="Blog Post" class="avatar-3xl object-fit-cover rounded-2">
                                    <img src="{{ asset('assets/images/small/img-8.jpg') }}" alt="Blog Post" class="avatar-3xl object-fit-cover rounded-2">
                                    <img src="{{ asset('assets/images/small/img-9.jpg') }}" alt="Blog Post" class="avatar-3xl object-fit-cover rounded-2">
                                    <img src="{{ asset('assets/images/small/img-10.jpg') }}" alt="Blog Post" class="avatar-3xl object-fit-cover rounded-2">
                                    <img src="{{ asset('assets/images/small/img-11.jpg') }}" alt="Blog Post" class="avatar-3xl object-fit-cover rounded-2">
                                    <img src="{{ asset('assets/images/small/img-12.jpg') }}" alt="Blog Post" class="avatar-3xl object-fit-cover rounded-2">
                                </div>
...
<script src="{{ asset('assets/js/pages/blog-list.init.js') }}"></script>
<!-- App js -->
