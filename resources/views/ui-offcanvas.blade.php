...
@section('title', 'UI Off-Canvas | Urbix Admin & Dashboards Template')
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex align-items-center gap-3">
                            ...
                            <ul class="nav nav-pills nav-preview nav-primary mb-0" id="offcanvas-basic" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="html-offcanvas-basic-tab" data-bs-toggle="pill" data-bs-target="#html-offcanvas-basic" type="button" role="tab" aria-controls="html-offcanvas-basic" aria-selected="true">HTML</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="preview-offcanvas-basic-tab" data-bs-toggle="pill" data-bs-target="#preview-offcanvas-basic" type="button" role="tab" aria-controls="preview-offcanvas-basic" aria-selected="false">Preview</button>
                                </li>
                            </ul>
                        </div>
                        <div class="card-body">
                            <p class="text-muted mb-4">Use the buttons below to show and hide an offcanvas element via JavaScript that toggles the <code>.show</code> class on an element with the <code>.offcanvas</code> class.</p>
                            <div class="tab-content" id="offcanvas-basicContent">
                                <div class="tab-pane fade show active" id="html-offcanvas-basic" role="tabpanel" aria-labelledby="html-offcanvas-basic-tab" tabindex="0">
                                ...
                                <div class="tab-pane fade" id="preview-offcanvas-basic" role="tabpanel" aria-labelledby="preview-offcanvas-basic-tab" tabindex="0">
                ...
                <div class="col-xl-6">
                    <div class="card">
                        <div class="card-header d-flex align-items-center gap-3">
                            ...
                            <ul class="nav nav-pills nav-preview nav-primary mb-0" id="body-scrolling" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="html-body-scrolling-tab" data-bs-toggle="pill" data-bs-target="#html-body-scrolling" type="button" role="tab" aria-controls="html-body-scrolling" aria-selected="true">HTML</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="preview-body-scrolling-tab" data-bs-toggle="pill" data-bs-target="#preview-body-scrolling" type="button" role="tab" aria-controls="preview-body-scrolling" aria-selected="false">Preview</button>
                                </li>
                            </ul>
                        </div>
                        <div class="card-body">
                            <p class="text-muted mb-4">You can also enable <code>&lt;body&gt;</code> scrolling with a visible backdrop.</p>
                            <div class="tab-content" id="body-scrollingContent">
                                <div class="tab-pane fade show active" id="html-body-scrolling" role="tabpanel" aria-labelledby="html-body-scrolling-tab" tabindex="0">
                                    <button class="btn btn-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasWithBothOptions" aria-controls="offcanvasWithBothOptions">Enable body scrolling</button>
                                ...
                                <div class="tab-pane fade" id="preview-body-scrolling" role="tabpanel" aria-labelledby="preview-body-scrolling-tab" tabindex="0">
                ...
                <div class="col-xl-6">
                    <div class="card">
                        <div class="card-header d-flex align-items-center gap-3">
                            ...
                            <ul class="nav nav-pills nav-preview nav-primary mb-0" id="static-backdrop" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="html-static-backdrop-tab" data-bs-toggle="pill" data-bs-target="#html-static-backdrop" type="button" role="tab" aria-controls="html-static-backdrop" aria-selected="true">HTML</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="preview-static-backdrop-tab" data-bs-toggle="pill" data-bs-target="#preview-static-backdrop" type="button" role="tab" aria-controls="preview-static-backdrop" aria-selected="false">Preview</button>
                                </li>
                            </ul>
                        </div>
                        <div class="card-body">
                            <p class="text-muted mb-4">When backdrop is set to static, the offcanvas will not close when clicking outside of it.</p>
                            <div class="tab-content" id="static-backdropContent">
                                <div class="tab-pane fade show active" id="html-static-backdrop" role="tabpanel" aria-labelledby="html-static-backdrop-tab" tabindex="0">
                                ...
                                <div class="tab-pane fade" id="preview-static-backdrop" role="tabpanel" aria-labelledby="preview-static-backdrop-tab" tabindex="0">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex align-items-center gap-3">
                            ...
                            <ul class="nav nav-pills nav-preview nav-primary mb-0" id="body-scrolling-backdrop" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="html-body-scrolling-backdrop-tab" data-bs-toggle="pill" data-bs-target="#html-body-scrolling-backdrop" type="button" role="tab" aria-controls="html-body-scrolling-backdrop" aria-selected="true">HTML</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="preview-body-scrolling-backdrop-tab" data-bs-toggle="pill" data-bs-target="#preview-body-scrolling-backdrop" type="button" role="tab" aria-controls="preview-body-scrolling-backdrop" aria-selected="false">Preview</button>
                                </li>
                            </ul>
                        </div>
                        <div class="card-body">
                            <p class="text-muted mb-4">Scrolling the <code>&lt;body&gt;</code> element is disabled when an offcanvas and its backdrop are visible. Use the data-bs-scroll attribute to enable <code>&lt;body&gt;</code> scrolling.</p>
                            <div class="tab-content" id="body-scrolling-backdropContent">
                                <div class="tab-pane fade show active" id="html-body-scrolling-backdrop" role="tabpanel" aria-labelledby="html-body-scrolling-backdrop-tab" tabindex="0">
                                        ...
                                        <div class="offcanvas-body">
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body p-4 text-center">
                                                    ...
                                                    <a href="javascript:void(0)" class="btn btn-success mt-3">Explore Collection</a>
                                                </div>
                                            </div>
                                            <div class="card">
                                ...
                                <div class="tab-pane fade" id="preview-body-scrolling-backdrop" role="tabpanel" aria-labelledby="preview-body-scrolling-backdrop-tab" tabindex="0">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex align-items-center gap-3">
                            ...
                            <ul class="nav nav-pills nav-preview nav-primary mb-0" id="offcanvas-placements" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="html-offcanvas-placements-tab" data-bs-toggle="pill" data-bs-target="#html-offcanvas-placements" type="button" role="tab" aria-controls="html-offcanvas-placements" aria-selected="true">HTML</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="preview-offcanvas-placements-tab" data-bs-toggle="pill" data-bs-target="#preview-offcanvas-placements" type="button" role="tab" aria-controls="preview-offcanvas-placements" aria-selected="false">Preview</button>
                                </li>
                            </ul>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="tab-content" id="offcanvas-placementsContent">
                                <div class="tab-pane fade show active" id="html-offcanvas-placements" role="tabpanel" aria-labelledby="html-offcanvas-placements-tab" tabindex="0">
                                    <div class="d-flex align-items-center gap-3 flex-wrap">
                                ...
                                <div class="tab-pane fade" id="preview-offcanvas-placements" role="tabpanel" aria-labelledby="preview-offcanvas-placements-tab" tabindex="0">
