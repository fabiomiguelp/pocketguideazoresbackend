...
@section('title', 'UI Cookies | Urbix Admin & Dashboards Template')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card min-h-300px">
                        ...
                        <div class="card-body">
                            <p class="text-muted mb-4">Creates a simple notification for users about cookie usage, ensuring compliance with cookie laws while maintaining a user-friendly experience.</p>
                            <div class="position-absolute bottom-0 end-0 w-100">
                                <div class="d-flex align-items-center rounded p-3 border border-primary-subtle bg-primary-subtle mx-4 mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="position-absolute bottom-0 end-0 w-100 max-w-384px">
                                <div class="card border card-body mx-6">
                                    ...
                                    <p class="card-text">To provide you with the best browsing experience, we use cookies on our website. <a href="javascript:void(0)">Learn more about our cookie policy</a>.</p>
                        ...
                        <div class="card-body">
                            ...
                            <div class="position-absolute bottom-0 end-0 w-100 max-w-384px">
                                <div class="card card-body text-bg-dark mx-6">
                                    ...
                                    <a href="javascript:void(0)" class="text-decoration-underline mb-5 link-light link-offset-1 link-opacity-75-hover">Learn more</a>
                                    <div class="d-flex align-items-center justify-content-between gap-2">
                ...
                <div class="col-12">
                    <div class="card min-h-500px">
                        ...
                        <div class="card-body">
                            <p class="text-muted mb-4">This example presents a cookies consent message that informs users about the website's use of cookies to enhance their browsing experience. It includes a clear message, a link for more information, and buttons for users to accept or decline cookie usage.</p>
                            <div class="position-absolute bottom-0 end-0 w-100 max-w-384px">
                                <div class="card border card-body mx-6">
                                    ...
                                    <a href="javascript:void(0)" class="text-decoration-underline mb-5 link-primary link-offset-1 link-opacity-75-hover">Read more</a>
                ...
                <div class="col-12">
                    <div class="card min-h-500px">
                        ...
                        <div class="card-body">
                            <p class="text-muted mb-4">This cookie notification informs users about cookie usage for personalization, social media, and analytics. Users can accept or decline for transparency and choice.</p>
                            <div class="position-absolute bottom-0 end-0 w-100">
                                <div class="card border card-body mx-6">
                                    <h5 class="card-title mb-3 text-uppercase fw-semibold">THIS WEBSITE USES COOKIES</h5>
                                    <p class="mb-3">
                                        We use cookies to personalize content and ads, to provide social media features and to analyze our traffic. We also share information about your use of our site with our social media, advertising and analytics partners who may combine it collected from your use of their services.
                                    </p>
                            ...
                            <div class="position-absolute bottom-0 end-0 w-100">
                                <div class="card card-body text-bg-dark rounded-0 mx-6">
                                    <div class="d-flex align-items-center gap-2 justify-content-between flex-wrap">
                                        <p class="d-flex align-items-center gap-1 flex-wrap m-0"><span class="fs-20">🍪</span> We are using Cookies! For more information visit this page<a href="javascript:void(0)" class="text-decoration-underline link-primary link-offset-2 link-opacity-75-hover">Cookie policy.</a></p>
                            ...
                            <div class="position-absolute bottom-0 end-0 w-100 d-flex justify-content-center">
                                <div class="card card-body text-bg-dark fs-12 p-4 mx-6 max-w-620px">
                                    <div class="d-flex align-items-center gap-2 justify-content-between">
                                        <p class="m-0">
                                            MyApp uses cookies to personalize your experience on our website. By continuing to use this site, you agree to our
                                            <a href="javascript:void(0)" class="text-decoration-underline link-primary link-offset-2 link-opacity-75-hover">Cookie policy</a>.
                                        </p>
