...
@section('title', 'UI Form Validation | Urbix Admin & Dashboards Template')
                    ...
                    <div class="card card-h-100">
                        ...
                        <div class="card-body">
                            ...
                            <form class="needs-validation" novalidate>
                                ...
                                <input type="text" class="form-control" placeholder="Username" id="userNameValidation01" required>
                        ...
                        <div class="card-body">
                            ...
                            <form class="needs-validation" novalidate>
                                <div class="position-relative">
                                    ...
                                    <input type="text" class="form-control" placeholder="Username" id="userNameValidation02" required>
                            ...
                            <form class="row g-3 needs-validation" novalidate>
                                ...
                                <div class="col-xl-3">
                                    ...
                                    <select class="form-select" id="validationCustom04" required>
                                        <option selected disabled value="Country">Choose...</option>
                                ...
                                <div class="col-12">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="invalidCheck" id="invalidCheck" required>
                    ...
                    <div class="card card-h-100">
                        ...
                        <div class="card-body">
                            ...
                            <form class="row g-3 needs-validation">
                                ...
                                <div class="col-12">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="invalidCheck2" id="invalidCheck2" required>
                        ...
                        <div class="card-body">
                            ...
                            <form class="row g-3 needs-validation">
                                ...
                                <div class="col-xl-4">
                                    ...
                                    <input type="text" class="form-control is-valid" id="validationServer02" value="Smith" required>
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="form-check">
                                        <input class="form-check-input is-invalid" type="checkbox" value="invalidCheck3" id="invalidCheck3" aria-describedby="invalidCheck3Feedback" required>
...
<script src="{{ asset('assets/js/form/form-validation.init.js') }}"></script>
