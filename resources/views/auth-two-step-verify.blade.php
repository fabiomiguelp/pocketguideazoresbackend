        ...
        <div class="col-12 col-md-8 col-lg-6 col-xl-5">
            <div class="card mx-xxl-8 shadow-none">
                <div class="card-body p-8">
                    <img src="{{ asset('assets/images/auth/email.png') }}" alt="Email Image" class="h-56px w-56px mx-auto d-block mb-3">
...
<script src="{{ asset('assets/js/auth/two-step-verification.init.js') }}"></script>
@endsection